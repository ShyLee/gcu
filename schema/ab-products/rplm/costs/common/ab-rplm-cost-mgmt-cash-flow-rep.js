...
function onClickCashFlow(event){
	...
	if(controller.rowRestriction){
		...
		panel.setTitle(getMessage("reportCashFlowDetails_title").replace("{0}", getCostTypeMessage(controller.displayVAT.type, controller.isMcAndVatEnabled))+" "+controller.getAssetKeyLabel(controller.projectionType)+": "+ controller.rowRestriction.value);
	}
}
