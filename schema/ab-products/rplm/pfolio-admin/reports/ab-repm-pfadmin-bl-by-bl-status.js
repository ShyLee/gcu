var abRepmPfadminBlByBlStatusController = View.createController('abRepmPfadminBlByBlStatusCtrl',{
	...
	getSqlRestriction: function(){
		...
		restriction += this.getSqlFieldRestriction("ctry_id", panel, "bl.ctry_id");
		restriction += this.getSqlFieldRestriction("regn_id", panel, "bl.regn_id");
		restriction += this.getSqlFieldRestriction("state_id", panel, "bl.state_id");
		restriction += this.getSqlFieldRestriction("city_id", panel, "bl.city_id");
