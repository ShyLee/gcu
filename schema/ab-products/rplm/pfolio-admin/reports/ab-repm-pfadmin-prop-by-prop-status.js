var abRepmPfadminPropByPropStatusController = View.createController('abRepmPfadminPropByPropStatusCtrl',{
	...
	getSqlRestriction: function(){
		...
		restriction += this.getSqlFieldRestriction("ctry_id", panel, "property.ctry_id");
		restriction += this.getSqlFieldRestriction("regn_id", panel, "property.regn_id");
		restriction += this.getSqlFieldRestriction("state_id", panel, "property.state_id");
		restriction += this.getSqlFieldRestriction("city_id", panel, "property.city_id");
