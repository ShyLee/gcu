...
var abRepmPfadminItemsByLocationController = View.createController('abRepmPfadminItemsByLocationController', {
	...
	abRepmPfadminItemsByLocBuildingDetails_afterRefresh: function(){
		...
		if(valueExistsNotEmpty(this.abRepmPfadminItemsByLocBuildingDetails.getFieldValue('bl.bldg_photo'))){
			this.abRepmPfadminItemsByLocBuildingDetails.showImageDoc('image_field', 'bl.bl_id', 'bl.bldg_photo');
		}else{
			this.abRepmPfadminItemsByLocBuildingDetails.fields.get('image_field').dom.src = null;
			this.abRepmPfadminItemsByLocBuildingDetails.fields.get('image_field').dom.alt = getMessage('text_no_image');
		}
	...
	abRepmPfadminItemsByLocPropertyDetails_afterRefresh: function(){
		...
		if(valueExistsNotEmpty(this.abRepmPfadminItemsByLocPropertyDetails.getFieldValue('property.prop_photo'))){
			this.abRepmPfadminItemsByLocPropertyDetails.showImageDoc('image_field', 'property.pr_id', 'property.prop_photo');
		}else{
			this.abRepmPfadminItemsByLocPropertyDetails.fields.get('image_field').dom.src = null;
			this.abRepmPfadminItemsByLocPropertyDetails.fields.get('image_field').dom.alt = getMessage('text_no_image');
		}
		// format currency fields
