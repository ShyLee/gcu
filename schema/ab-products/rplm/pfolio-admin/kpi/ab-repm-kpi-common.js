...
function isInDashboard(view){
	...
	if (valueExists(view.parameters) && valueExists(view.parameters["isDialogWindow"]) && view.parameters["isDialogWindow"]) {
		result = false;
	} else if(view.type === 'dashboard' || view.getOpenerView().type == 'dashboard') {
		result = true;
	}
	return result;
}
...
function getGroupByParameter(controllerObj){
	...
	} else if (controllerObj.view.getOpenerView().type == 'dashboard' && valueExists(controllerObj.view.getOpenerView().dashboardConfigObj)
...
function getDashboardConfigObject(controller, chartId){
	...
	} else if (valueExists(controller.view.getOpenerView().dashboardConfigObj)){
