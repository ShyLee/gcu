var rplmOptionsController = View.createController('rplmOptions', {
    ...
    afterInitialDataFetch: function(){
        ...
        if (View.controllers.get('tabsLeaseAdminMngByLocation') != undefined) {
            this.buttonsPanelOptions.actions.items[this.buttonsPanelOptions.actions.indexOfKey('back')].show(false);
            this.buttonsPanelOptions.actions.items[this.buttonsPanelOptions.actions.indexOfKey('continue')].show(false);
            this.buttonsPanelOptions.actions.items[this.buttonsPanelOptions.actions.indexOfKey('finish')].show(false);
