var rplmClausesController = View.createController('rplmClauses', {
    ...
    afterInitialDataFetch: function(){
        ...
        if (View.controllers.get('tabsLeaseAdminMngByLocation') != undefined) {
            this.buttonsPanelClauses.actions.items[this.buttonsPanelClauses.actions.indexOfKey('back')].show(false);
            this.buttonsPanelClauses.actions.items[this.buttonsPanelClauses.actions.indexOfKey('continue')].show(false);
            this.buttonsPanelClauses.actions.items[this.buttonsPanelClauses.actions.indexOfKey('finish')].show(false);
