var rplmAmendmentsController = View.createController('rplmAmendments',{
	...
	afterInitialDataFetch: function(){
		...
		if(View.controllers.get('tabsLeaseAdminMngByLocation') != undefined){
			this.buttonsPanelAmendments.actions.items[this.buttonsPanelAmendments.actions.indexOfKey('back')].show(false);
			this.buttonsPanelAmendments.actions.items[this.buttonsPanelAmendments.actions.indexOfKey('finish')].show(false);
