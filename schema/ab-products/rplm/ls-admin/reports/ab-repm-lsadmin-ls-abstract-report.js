...
var abRepmLsadminLsAbstractReportController = View.createController('abRepmLsadminLsAbstractReportCtrl', {
	...
	abRepmLsadminLsAbstractReport_gridPanel_onDetails: function(row){
		...
		var restriction = "ls.ls_id = '" + row.getFieldValue("ls.ls_id") + "'";
		this.row = row;
		...
		this.abRepmLsadminLsAbstractDetails_lsContactsPanel.refresh(restriction);
	...
	abRepmLsadminLsAbstractDetails_bldgPanel_afterRefresh: function(){
		if (valueExistsNotEmpty(this.abRepmLsadminLsAbstractDetails_bldgPanel.getFieldValue('bl.bldg_photo'))) {
			this.abRepmLsadminLsAbstractDetails_bldgPanel.showImageDoc('image_field', 'bl.bl_id', 'bl.bldg_photo');
		}else{
			this.abRepmLsadminLsAbstractDetails_bldgPanel.fields.get('image_field').dom.src = null;
			this.abRepmLsadminLsAbstractDetails_bldgPanel.fields.get('image_field').dom.alt = getMessage('text_no_image');
		}
	},
	abRepmLsadminLsAbstractDetails_propPanel_afterRefresh: function(){
		if (valueExistsNotEmpty(this.abRepmLsadminLsAbstractDetails_propPanel.getFieldValue('property.prop_photo'))) {
			this.abRepmLsadminLsAbstractDetails_propPanel.showImageDoc('image_field', 'property.pr_id', 'property.prop_photo');
		}else{
			this.abRepmLsadminLsAbstractDetails_propPanel.fields.get('image_field').dom.src = null;
			this.abRepmLsadminLsAbstractDetails_propPanel.fields.get('image_field').dom.alt = getMessage('text_no_image');
		}
	}
})
...
function onApplyFilter(crtFilter, printableRestriction, displayVAT, displayCurrency){
	...
	try {
	    ...
	    View.openJobProgressBar(getMessage('msg_summarize_costs'), jobId, '', function(status) {
	    	...
	    	onRefreshReport(crtFilter, printableRestriction, displayVAT, displayCurrency);
