		...
		if(costs.ids.length > 0){
			try{
			    ...
			    View.openJobProgressBar(getMessage('msg_update_costs'), jobId, '', function(status) {
		    		...
		    		summarizeCosts(controller, overviewPanel, dateFrom, dateTo, period, isFromCosts, isFromScheduledCosts, isFromRecurringCosts, isActiveRecurringCosts, isSqlStringRestriction, displayVAT, displayCurrency);
			    });
			}catch(e){
...
function summarizeCosts(controller, overviewPanel, dateFrom, dateTo, period, isFromCosts, isFromScheduledCosts, isFromRecurringCosts, isActiveRecurringCosts, isSqlStringRestriction, displayVAT, displayCurrency){
