var rplmLeaseController = View.createController('rplmLease',{
	...
	leasesTenantGrid_edit_onClick: function(row){
		this.editOnClick(row);
	},
	leasesLandlordGrid_edit_onClick: function(row){
		this.editOnClick(row);
	},
	leasesTenantGrid_onNew: function(){
		/*
	...
	leasesLandlordGrid_onNew: function(){
