var rplmSuiteController = View.createController('rplmSuite',{
	...
	gridSuiteLeaseNotAssigned_delete_onClick: function(row){
	...
	gridSuiteLease_split_onClick: function(row){
	...
	gridSuiteLeaseNotAssigned_split_onClick: function(row){
		if (row.getFieldValue('su.area_rentable') > 0 || row.getFieldValue('su.area_comn') > 0 || row.getFieldValue('su.area_usable') > 0) {
			View.showMessage(getMessage('error_split'));
		}
		else {
	...
	gridSuiteLeaseNotAssigned_edit_onClick: function(row){
	...
	gridSuiteLease_edit_onClick: function(row){
