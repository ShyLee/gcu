...
public class CommonHandlers extends EventHandlerBase {
     ...
     *                retrieved.
     */
    public void notify(EventHandlerContext context) {
        ...
        final String port = getEmailPort(context);
  	    ...
  	    String activityId = context.getString("activityId", null);
        ...
        if (context.parameterExists("notifyEmailAddressSqlQuery")) {
            notifyEmailAddressSqlQuery = (String) context
                .getParameter("notifyEmailAddressSqlQuery");
        }
        ...
        if (StringUtil.notNullOrEmpty(notifyEmailAddress)) {
            ...
            List rows = selectDbRecords(context, notifyEmailAddressSqlQuery);
     ...
     */
    public void notifyUsingArchibusIdentity(EventHandlerContext context) {
     ...
     * @exception ExceptionBase Description of the Exception
     */
    public void executeSQL(EventHandlerContext context) {
        boolean updatedRecordsRequired = StringUtil.toBoolean(context
            .getParameter(KEY_UPDATED_RECORDS_REQUIRED));
     ...
     * @exception ExceptionBase Description of the Exception
     */
    public void chainRule(EventHandlerContext context) {
        ...
        int i = 1;
        while (found) {
            String ruleKey = "chainedRule" + Integer.toString(i);
            ...
            if (context.parameterExists(ruleKey)) {
                ...
                EventHandlerContext chainedRuleContext = getContextForChainedRule(context, ruleKey);
     ...
     * @exception ExceptionBase Description of the Exception
     */
    public void saveRecordOverridingValues(EventHandlerContext context) {
        ...
        final String namesOfFieldsToUpdate = (String) context
            .getParameter("namesOfFieldsToOverride");
        ...
        final String typesOfFieldsToUpdate = (String) context
            .getParameter("typesOfFieldsToOverride");
        ...
        StringTokenizer fields = new StringTokenizer(namesOfFieldsToUpdate, ";");
        StringTokenizer values = new StringTokenizer(valuesOfFieldsToUpdate, ";");
        StringTokenizer types = new StringTokenizer(typesOfFieldsToUpdate, ";");
        ...
        Map valuesStripped = stripPrefix(fieldValues);
     ...
     * @param context
     */
    public void getUserInfo(EventHandlerContext context) {
        JSONObject userInfo = new JSONObject();

        UserAccount.Immutable userAccount = getUserAccount(context);
        UserRole.Immutable userRole = getUserRole(context);
        ...
        for (String group : userRole.getGroups()) {
            groups.put(group);
        }
