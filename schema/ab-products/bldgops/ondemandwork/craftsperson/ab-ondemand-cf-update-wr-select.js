var abOdmdCfUpdWrSlktControllert = View.createController("abOdmdCfUpdWrSlktControllert",{
	...
	requestConsole_afterRefresh: function(){
		...
		var ifRefresh = top.window.location.parameters["refresh_from_ab_helpdesk_cf_workrequest_updateDetails"]; 
		if( valueExists(ifRefresh)&& ifRefresh == true){
			top.window.location.parameters["refresh_from_ab_helpdesk_cf_workrequest_updateDetails"] = false;
