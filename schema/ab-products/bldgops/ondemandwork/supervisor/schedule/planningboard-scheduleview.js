...
AFM.planboard.ScheduleView = Base.extend({	
	...
	onRemoveEntryFromResource: function(entry) {
  	...
  	initContextMenus: function() {
  		 ...
  		 */
  		this.entryEditContextMenu = new YAHOO.widget.ContextMenu("entryEdit-cm", {lazyload: true,width: "100px" } );		        
    ...
    renderEntries: function() {  	
  	...
  	refreshEntries: function() {  	   
   	...
   	loadWorkRequests: function() {
   		var records = AFM.planboard.ScheduleController.loadWorkRequests({});
...
AFM.planboard.ScheduleController = {  
	...
	loadWorkRequests: function(restriction) {
		var result = {};
		try{
			 result = Workflow.callMethod("AbBldgOpsOnDemandWork-Schedule-filterWorkRequests", restriction);
	 	}catch(e){
			Workflow.handleError(e);
		}
		if (result.code == 'executed') {  
