var Controller = View.createController('dashFrcstTrMon', {
...
function showPmSchedule(month){
    ...
    if (tr != 'Total Hours:' && tr != 'Total Costs:') {
        ...
        PMSrecords['pmressum.date_todo.from'] = this.dateFrom;
        PMSrecords['pmressum.date_todo.to'] = this.dateTo;
...
function Recalculate(){
	var openerController = View.getOpenerView().controllers.get("dashFrcstTrMon");
	openerController.afterInitialDataFetch();
}
