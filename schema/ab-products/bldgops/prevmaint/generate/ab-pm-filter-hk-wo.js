...
function openDialog(panelid,type){
    if (type == "bl") {
        View.selectValue(panelid, getMessage('blCode'), ['pms.bl_id'], 'pms', ['pms.bl_id'], ['pms.bl_id'], null, null, null, null, null, 800, 500, null, null, null);
    }
    else 
        if (type == "fl") {
            View.selectValue(panelid, getMessage('flCode'), ['pms.fl_id'], 'pms', ['pms.fl_id'], ['pms.fl_id'], null, null, null, null, null, 800, 500, null, null, null);
        }
        else 
            if (type == "site") {
