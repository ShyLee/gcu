var abHpdRVSelectArchivedController =  View.createController("abHpdRVSelectArchivedController",{
	...
	requestConsole_onClear: function(){
 	...
 	getRestriction: function(){
 		var dateRequestedFrom = this.requestConsole.getFieldElement("hactivity_log.date_requested.from").value;
		var dateRequestedTo = this.requestConsole.getFieldElement("hactivity_log.date_requested.to").value;
