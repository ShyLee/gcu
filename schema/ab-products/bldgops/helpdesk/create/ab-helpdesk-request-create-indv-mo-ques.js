...
// 			return;
// 		}
// 		if(!valueExistsNotEmpty(helpDeskGroupMoveController.emPanel.getFieldValue("rmpct.parent_pct_id"))){
// 			popUpSelectDvDpEtc();
// 		}
	...
	questPanel_onSave: function(){
		...
		try {
			...
			if(requestDate!=null&&new Date(requestDate)<new Date()){
			    ...
			    this.tabs.move_date = getCurrentDate();
			}else{
...
function checkMoveDate(){
	...
	}else if(!helpDeskGroupMoveController.isApproveOrIssue&&compareLocalizedDates(move_end,getCurrentDate())){
