...
CREATE VIEW resview AS (SELECT recurring_rule,doc_event,ac_id,comments,user_created_by,cost_res,date_cancelled,date_last_modified,date_created,dp_id,dv_id,phone,user_requested_by,contact,date_end,date_start,res_id,user_requested_for,user_last_modified_by,email,reservation_name,status,time_end,time_start,res_type,res_parent,recurring_date_modified,attendees FROM reserve) UNION ALL (SELECT recurring_rule,doc_event,ac_id,comments,user_created_by,cost_res,date_cancelled,date_last_modified,date_created,dp_id,dv_id,phone,user_requested_by,contact,date_end,date_start,res_id,user_requested_for,user_last_modified_by,email,reservation_name,status,time_end,time_start,res_type,res_parent,recurring_date_modified,attendees FROM hreserve);

IF EXISTS (SELECT 1 FROM sysobjects WHERE name = 'resrmview' AND type = 'V') DROP VIEW resrmview;

CREATE VIEW resrmview AS (SELECT rmres_id,comments,cost_rmres,date_cancelled,date_last_modified,date_created,bl_id,date_start,res_id,user_last_modified_by,status,time_end,time_start,config_id,fl_id,rm_arrange_type_id,rm_id,recurring_order,date_rejected,guests_external,guests_internal FROM reserve_rm) UNION ALL (SELECT rmres_id,comments,cost_rmres,date_cancelled,date_last_modified,date_created,bl_id,date_start,res_id,user_last_modified_by,status,time_end,time_start,config_id,fl_id,rm_arrange_type_id,rm_id,recurring_order,date_rejected,guests_external,guests_internal FROM hreserve_rm);
...
INSERT INTO afm_flds (table_name,field_name,data_type,afm_size,decimals,allow_null,primary_key,ref_table,afm_type,string_format,num_format, comments,afm_module,enum_list,ml_heading) VALUES ('rrmonreq','status',1,16,0,1,0,NULL,2070,5,0,'Reservations-v16.3',20,'Awaiting App.;Awaiting Approval;Rejected;Rejected;Cancelled;Cancelled;Confirmed;Confirmed;Closed;Closed','Status of
Reservation');
