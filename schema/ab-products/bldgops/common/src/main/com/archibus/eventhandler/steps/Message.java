...
public class Message extends HelpdeskEventHandlerBase {
	...
	public void format(String localName) {
        ...
        if(isSubjectRichFormatted()){
            ...
            try {
                this.subject = MessageHelper.processTemplate(this.subjectMessageId, subjectMsg, this.dataModel);
        ...
        if(isBodyRichFormatted()){
            ...
            this.body = bodyMsg;
            try {
                this.body = MessageHelper.processTemplate(this.bodyMessageId, bodyMsg, this.dataModel);
            } catch(TemplateException te){
