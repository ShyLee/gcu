...
public class RequestHandler extends HelpdeskEventHandlerBase {
    ...
    /**
     * 
     * Backto the help request by manager when approval step is active.<br/>
     * <p>
     * <b>Inputs:</b>
     * <ul>
     * <li>record : help request -- the form values submitted</li>
     ...
     * <li>Save help request</li>
     * <li>
     * {@link com.archibus.eventhandler.helpdesk.RequestHandler#backtoStep(EventHandlerContext, int, int, String)
     * Backto previous step}</li>
     * <li>{@link #archiveRequest(EventHandlerContext) Archive rejected request}</li>
     * </ol>
     * </p>
     */
    public void backtoRequest(final JSONObject record, final String comments) {
        final EventHandlerContext context = ContextStore.get().getEventHandlerContext();
        final Map fieldValues = parseJSONObject(context, record);
        // fields of activity_log_step_waiting
        final Map stepValues =
        ...
        final String acvitity_type = notNull(values.get("activity_type"));
        
        backtoStep(context, activity_log_id, stepLogId, comments, acvitity_type);
    }
     ...
     * @param activityType
     */
    private void backtoStep(final EventHandlerContext context, final int activity_log_id,
            final int stepLogId, final String comments, final String activityType) {
        final HelpdeskStepManager stepmgr = new HelpdeskStepManager(context, activity_log_id);
        stepmgr.backtoStep(stepLogId, comments,
            getParentContextAttributeXPath(context, "/*/preferences/@user_name"), activityType);
    }
