...
INSERT INTO afm_tbls (table_name,comments,afm_module,title,is_sql_view)  SELECT 'resview','SQL view combining reserve and hreserve',20,'All Reservations',1   WHERE NOT EXISTS (SELECT 1 FROM afm_tbls WHERE table_name = 'resview')

INSERT INTO afm_tbls (table_name,comments,afm_module,title,is_sql_view)  SELECT 'resrsview','SQL view combining reserve_rs and hreserve_rs',20,'All Resource Reservations',1   WHERE NOT EXISTS (SELECT 1 FROM afm_tbls WHERE table_name = 'resrsview')

INSERT INTO afm_tbls (table_name,comments,afm_module,title,is_sql_view)  SELECT 'resrmview','SQL view combining reserve_rm and hreserve_rm',20,'All Room Reservations',1   WHERE NOT EXISTS (SELECT 1 FROM afm_tbls WHERE table_name = 'resrmview')
...
SELECT ml_heading FROM afm_flds WHERE table_name = 'resrmview' AND field_name = 'config_id'
