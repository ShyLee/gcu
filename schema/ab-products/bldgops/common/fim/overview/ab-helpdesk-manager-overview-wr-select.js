var abHpdMgrOverviewWrSlktController = View.createController("abHpdMgrOverviewWrSlktController",{
	...
	requestConsole_afterRefresh: function(){
		...
		var ifRefresh = top.window.location.parameters["refresh_from_ab_helpdesk_mgr_overview_wr_select"]; 
		if( valueExists(ifRefresh)&& ifRefresh == true){
			top.window.location.parameters["refresh_from_ab_helpdesk_mgr_overview_wr_select"] = false;
