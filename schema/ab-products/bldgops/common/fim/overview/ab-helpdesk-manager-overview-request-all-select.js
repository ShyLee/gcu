var abHpdMgrOverviewReqAllSlktController = View.createController("abHpdMgrOverviewReqAllSlktController",{
	...
	requestConsole_afterRefresh: function(){
		...
		var ifRefresh = top.window.location.parameters["refresh_from_ab_helpdesk_mgr_overview_request_all_select"]; 
		if( valueExists(ifRefresh)&& ifRefresh == true){
			top.window.location.parameters["refresh_from_ab_helpdesk_mgr_overview_request_all_select"] = false;
