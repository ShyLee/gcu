var abHpdReqCloseSlktClosedController = View.createController("abHpdReqCloseSlktClosedController",{
	...
	requestConsole_afterRefresh: function(){
		...
		var ifRefresh = top.window.location.parameters["refresh_from_ab_helpdesk_request_close_select_closed"]; 
		if( valueExists(ifRefresh)&& ifRefresh == true){
			top.window.location.parameters["refresh_from_ab_helpdesk_request_close_select_closed"] = false;
