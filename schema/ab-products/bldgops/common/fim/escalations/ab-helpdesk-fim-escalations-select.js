var abHpdFimEscalationsSlktController = View.createController("abHpdFimEscalationsSlktController",{
	...
	requestConsole_afterRefresh: function(){
		...
		var ifRefresh = top.window.location.parameters["refresh_from_ab_helpdesk_fim_escalations_select"]; 
		if( valueExists(ifRefresh)&& ifRefresh == true){
			top.window.location.parameters["refresh_from_ab_helpdesk_fim_escalations_select"] = false;
