	...
	*/
	...
	requestPanel_onArchive: function(){
		if(confirm(getMessage("confirmArchive"))){
			...
			if(result.code =='executed'){
				top.window.location.parameters["refresh_from_ab_helpdesk_request_close_select_closed"] = true;
	...
	requestPanel_onClose: function(){
		if (confirm(getMessage("confirmClose"))) {	
			...
			if(result.code=='executed'){
				top.window.location.parameters["refresh_from_ab_helpdesk_request_close_select"] = true;
