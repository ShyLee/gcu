var abHpdFimEscalationsSlktCompletedController = View.createController("abHpdFimEscalationsSlktCompletedController",{
	...
	requestConsole_afterRefresh: function(){
		...
		var ifRefresh = top.window.location.parameters["refresh_from_ab_helpdesk_fim_escalations_select_completion"]; 
		if( valueExists(ifRefresh)&& ifRefresh == true){
			top.window.location.parameters["refresh_from_ab_helpdesk_fim_escalations_select_completion"] = false;
