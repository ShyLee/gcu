...
public abstract class AbstractMonthlyPattern extends AbstractIntervalPattern {
    ...
    /**
     * Check if the day is the day of week selected.
     * 
     * @param day day of the week
     * @return boolean
     */
    public final boolean checkDayOfTheWeek(final DayOfTheWeek day) {
        return this.dayOfTheWeek == day;
    }
    
    /**
     * Check if week is the week selected.
     * 
     * @param week week number
     * @return boolean
     */
    public final boolean checkWeekOfTheMonth(final Integer week) {
        boolean result = false;
        if (week == null || this.weekOfMonth == null) {
            result = false;
        } else {
            result = this.weekOfMonth.equals(week);
        }
        return result;
    }
