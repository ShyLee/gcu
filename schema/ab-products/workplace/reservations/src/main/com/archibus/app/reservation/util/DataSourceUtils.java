...
import com.archibus.app.reservation.domain.ITimePeriodBased;
...
public final class DataSourceUtils {
    ...
    public static String[][] getFieldsToProperties(final Map<String, String> mapping) {
        ...
        for (final String key : mapping.keySet()) {
            fieldsToProperties[index++] =
                    new String[] { key.substring(key.indexOf('.') + 1), mapping.get(key) };
        }
    ...
    public static long getDaysDifference(final ITimePeriodBased allocation,
        ...
        if (allocation.getStartDate() == null) {
            // @translatable
            throw new ExceptionBase("No reservation date available");
        }
