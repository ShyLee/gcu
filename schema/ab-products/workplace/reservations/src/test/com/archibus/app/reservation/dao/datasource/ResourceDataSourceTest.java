...
public class ResourceDataSourceTest extends ReservationDataSourceTestBase {
     ...
     */
    public void testCheckAllowedForBuilding() {
        final boolean allowed = this.resourceDataSource.checkAllowedForBuilding(COFFEE_HQ, BL_ID);
        Assert.assertTrue(allowed);
        
        final boolean notAllowed =
                this.resourceDataSource.checkAllowedForBuilding(COFFEE_JFK, BL_ID);
    ...
    public void testCheckAvailableResource() {
        ...
        final boolean notAllowed =
                this.resourceDataSource
                    .checkResourceAvailable(COFFEE_JFK, this.existingReservation);
        Assert.assertFalse(notAllowed);
    }
    ...
    public void testGetNumberOfReservedResources() {
        try {
            ...
            Assert.assertEquals(0,
                this.resourceDataSource.getNumberOfReservedResources(timePeriod, COFFEE_HQ, null));
            ...
            Assert.assertEquals(0, this.resourceDataSource.getNumberOfReservedResources(timePeriod,
                COFFEE_HQ, this.existingReservation.getReserveId()));
            ...
            Assert.assertEquals(totalCount,
                this.resourceDataSource.getNumberOfReservedResources(timePeriod, COFFEE_HQ, null));
            ...
            for (final TimePeriod otherPeriod : otherPeriods) {
                ...
                Assert.assertEquals(totalCount, this.resourceDataSource
                    .getNumberOfReservedResources(timePeriod, COFFEE_HQ, null));
            }
        } catch (final ParseException exception) {
            Assert.fail(exception.toString());
        }
