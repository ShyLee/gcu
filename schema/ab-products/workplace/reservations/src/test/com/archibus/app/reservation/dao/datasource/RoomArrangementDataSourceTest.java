...
public class RoomArrangementDataSourceTest extends ReservationDataSourceTestBase {
    ...
    /**
     * Test getting all reservable rooms.
     */
    public void testReservableRooms() {
        final List<RoomArrangement> rooms =
                this.roomArrangementDataSource.getReservableRooms(BL_ID, FL_ID, ARRANGE_TYPE_ID);
    ...
    public void testAllDayEvent() throws ParseException {
        ...
        final List<RoomArrangement> availableRooms =
                this.roomArrangementDataSource.findAvailableRooms(reservation, null, null, true,
                    null);
