...
public final class HotelingBookingCreateActionHelper {
    ...
    public static DataRecord createRmpctRecord(final JSONObject booking, final int activityLogId,
        ...
        DataRecord newRmpct = rmpctDS.createNewRecord();
        
        // set request values for the new record
        HotelingBookingCreateActionHelper.setRequestForNewRmpct(activityLogId, parentPctId, newRmpct);
        ...
        newRmpct = rmpctDS.saveRecord(newRmpct);
        newRmpct =
        ...
        HotelingBookingCreateActionHelper.setPctSpaceForNewRmpct(newRmpct, rmRec);
        // Set parent_pct_id
        HotelingBookingCreateActionHelper.setParentPctForNewRmpct(parentPctId, newRmpct);
