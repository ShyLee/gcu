...
public class TestHotelingHandler extends DataSourceTestBase {
    ...
    public void testCancelBookings() {
        ...
        try {
            handler.cancelBookings("0", pctIds, "", emIds, visitorIds, blIds, "" + activityLogId);
        } catch (final Throwable e) {
            fail(" Global Exception " + e);
        }
    }
    ...
    public void testApproveBookings() {
        ...
        try {
            handler.approveBookings("0", pctIds, "", emIds, visitorIds, "" + activityLogId);
        } catch (final Throwable e) {
            fail(" Global Exception " + e);
        }
    ...
    public void testRejectBookings() {
        ...
        try {
            handler.rejectBookings("0", pctIds, "", emIds, visitorIds, "" + activityLogId);
        } catch (final Throwable e) {
            fail(" Global Exception " + e);
        }
