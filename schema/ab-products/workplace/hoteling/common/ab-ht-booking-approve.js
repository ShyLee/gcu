    ...
    selectBookingGrid_onApprove: function(){
        ...
        for (var i = 0; i < rows.length; i++) {
            ...
            var pctId = row['rmpct.pct_id'];
			   activityLogId = row['rmpct.activity_log_id'];
        ...
        var parameters = {
            'operationLevel': 0,
            'pctParam': toJSON(pctParam),
			'parentPctId':parentPctId,
        	'emIdParam':toJSON(emIdParam),
			'vistorIdParam':toJSON(vistorIdParam),
        ...
        try {
			...
			var result = Workflow.callMethod('AbSpaceHotelling-HotelingHandler-approveBookings', 
																	...
																	emIdParam,vistorIdParam, activityLogId);
