...
function onFlNodeClick(){
		...
		if (booked == 'yes') {
			...
			addDrawingDynamic('rm',blId,flId,'abHotelRmHighlightDS','abHotelRmHighlightLabelDS',title);
		...
		if (booked == 'no') {
			...
			addDrawingDynamic('rm',blId,flId,'abHotelRmHighlightDS1','abHotelRmHighlightLabelDS',title);
 ...
 */
function addDrawingDynamic(tableName,buildingId,floorId,currentHighlightDS,currentLabelsDS,title) {
	...
	drawingPanel.addDrawing(restriction, opts);
