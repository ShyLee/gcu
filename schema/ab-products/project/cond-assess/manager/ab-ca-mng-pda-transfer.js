var controller = View.createController('pdaTransferProgress', {
	...
	startTransfer: function(){
		...
		if( this.progressReportParameters.transferAction == "OUT" ) {
			...
			Workflow.startJobWithUpload(this.transferInRuleId, this.progressReportParameters.importLocalFile, this.afterDataTransferStarted, this, this.progressReportParameters.isCompare,null, this.progressReportParameters.transferAction, fileExt);
