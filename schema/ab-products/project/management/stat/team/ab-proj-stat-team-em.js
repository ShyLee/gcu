var projStatTeamEmController = View.createController('projStatTeamEm', {
	projStatTeam_em_onSelect: function() {
		var records = this.projStatTeam_em.getSelectedRecords();
		...
		for (var i = 0; i < records.length; i++) {
			...
			var record = this.projStatTeam_dsEm.getRecord(restriction);
		...
		openerController.projStatTeamGrid.refresh();
