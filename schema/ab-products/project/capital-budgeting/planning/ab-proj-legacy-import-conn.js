var projLegacyImportController = View.createController('projLegacyImport', {
	...
	connectorExecuteJob: 'AbSystemAdministration-ConnectorJob-executeConnectorJob',
	job_id: 0,
...
function getConsoleRestrictionForProjects() {
	...
	if (dateStart != '') restriction += " AND project.date_start >= '" + dateStart + "'";
	var dateEnd = console.getFieldValue('project.date_end').trim();
	if (dateEnd != '') restriction += " AND project.date_end <= '" + dateEnd + "'";
	return restriction;
}
