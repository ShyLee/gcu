var projectEditController = View.createController('projectEdit',{
    ...
    projectEdit_projectForm_afterRefresh: function() {	
		var q_id = 'Project - ' + this.projectEdit_projectForm.getFieldValue('project.project_type');	
	...
	projectEdit_createProjectForm_afterRefresh: function() {	
		...
		} else this.projectEdit_createProjectForm.setFieldValue('project.project_type', '');
	},
	...
	projectEdit_createProjectForm_onSave: function() {
		...
		var result = Workflow.callMethod('AbCapitalBudgeting-CapitalBudgetingService-createProject', record);
		if (result.code == 'executed') {
		...
		if (template_project_id != "") {
			try {
				var jobId = Workflow.startJob('AbCapitalBudgeting-CapitalBudgetingService-copyTemplateProject', template_project_id, project_id, true);
