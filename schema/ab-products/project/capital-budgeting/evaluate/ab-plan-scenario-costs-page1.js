var planScenarioCostsPage1Controller = View.createController('planScenarioCostsPage1', {
	...
	afterViewLoad: function() {
        this.planScenarioCostsScenariosTable.addEventListener('afterGetData', this.planScenarioCostsScenariosTable_afterGetData, this);
    },
	...
	planScenarioCostsScenariosTable_afterGetData: function(panel, dataSet) {
		...
		for (var c = 0; c < dataSet.columnSubtotals.length; c++) {
			dataSet.columnSubtotals[c].localizedValues['projscns.cost_scenario'] = '';
			dataSet.columnSubtotals[c].localizedValues['projscns.design_cost'] = '';
		}
	},
