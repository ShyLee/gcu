...
public class CapitalProjectsHandler extends EventHandlerBase {
     ...
     *@exception ExceptionBase Description of the Exception
     */
    private String getRequestor(EventHandlerContext context, String mo_id, String project_id) {
        String requestor = null;
        if (notNull(mo_id).length() == 0) {
            requestor = (String) selectDbValue(context, "project", "requestor", "project_id = "
                    + literal(context, project_id));
        } else {
            requestor = (String) selectDbValue(context, "mo", "requestor", "mo_id = "
                    + literal(context, mo_id));
        }
        return requestor;
    }
     ...
     *@exception ExceptionBase Description of the Exception
     */
    private String getProjectManager(EventHandlerContext context, String project_id) {
        return (String) selectDbValue(context, "project", "proj_mgr", "project_id = "
                + literal(context, project_id));
    }
     ...
     *@exception ExceptionBase Description of the Exception
     */
    private String getDepartmentContact(EventHandlerContext context, String mo_id, String project_id) {
        String contact = null;
        if (notNull(mo_id).length() == 0) {
            contact = (String) selectDbValue(context, "project", "dept_contact", "project_id = "
                    + literal(context, project_id));
        } else {
            contact = (String) selectDbValue(context, "mo", "dept_contact", "mo_id = "
                    + literal(context, mo_id));
        }
        return contact;
    }
    ...
    private String getActivityLogFields(EventHandlerContext context, String excludeFields) {
        // XXX: use StringBuffer to hold string values !!!!
        StringBuffer fieldNames = new StringBuffer();
        // XXX: Never directly query schema table afl_flds!!!!
        String[] tableFieldNames = EventHandlerBase.getAllFieldNames(context, "activity_log");
    ...
    private String prepareStringList(String aValue, EventHandlerContext context) {

        StringTokenizer ids = new StringTokenizer(aValue, ";");
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void insertProjectQuestionnaireRecord(EventHandlerContext context) throws ExceptionBase {
        /*
        ...
        if (notNull(project_type).length() == 0) {
            // @translatable
            String errorMessage = "project_type is required!";
        ...
        final String sqlInsert = " INSERT INTO questionnaire  (questionnaire_id, title, table_name, field_name, description) VALUES ("
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void setFieldDefaultValue(EventHandlerContext context) {
        /*
        ...
        String parameterTableName = (String) context.getParameter("parameterTableName");
        String parameterFieldNames = (String) context.getParameter("parameterFieldNames");
        String parameterFieldValues = (String) context.getParameter("parameterFieldValues");
        String parameterFieldTypes = (String) context.getParameter("parameterFieldTypes");
        ...
        StringTokenizer fields = new StringTokenizer(parameterFieldNames, ";");
        StringTokenizer values = new StringTokenizer(parameterFieldValues, ";");
        StringTokenizer types = new StringTokenizer(parameterFieldTypes, ";");
        ...
        while (fields.hasMoreTokens() && values.hasMoreTokens() && types.hasMoreTokens()) {
            ...
            Object fieldValueObject = parseFieldValue(context, fieldVal, fieldType, fieldName);
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void createFCIScenario(EventHandlerContext context) {
        ...
        final String sqlInsert = "INSERT INTO actscns (proj_scenario_id, activity_log_id, fiscal_year) SELECT "
                + literal(context, proj_scenario_id)
                + ", activity_log_id, "
                + fiscal_year
                + " FROM activity_log WHERE activity_type='ASSESSMENT' AND project_id = "
                + literal(context, project_id)
                + " AND NOT EXISTS (SELECT 1 FROM actscns "
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void createProject(EventHandlerContext context) {
        /*
        ...
        Map fieldValues = context.getParameters("projectFields");
        if (this.log.isDebugEnabled()) {
        ...
        java.sql.Date date_start_date = (java.sql.Date) fieldValues.get("project.date_start");
        java.sql.Date date_end_date = (java.sql.Date) fieldValues.get("project.date_end");
        ...
        String projectIdSqlQuery = "SELECT project_id FROM project WHERE project_id = "
                + literal(context, project_id);
        List rows = selectDbRecords(context, projectIdSqlQuery);
        if (rows.size() == 0) {
            /*
            ...
            final String phone_req = (String) selectDbValue(context, "em", "phone", "em_id" + "="
                    + literal(context, requestor));
            final String phone_dept_contact = (String) selectDbValue(context, "em", "phone",
                "em_id" + "=" + literal(context, dept_contact));

            final String sqlInsert = "INSERT INTO project "
                    ...
                    + literal(context, phone_req) + "," + literal(context, dept_contact) + ","
                    + literal(context, phone_dept_contact) + "," + literal(context, summary) + ")";

            executeDbSql(context, sqlInsert, true);
        } else {
            // Group Move already includes item. Show error message
            // @translatable
            String errorMessage = "Project [{0}] already exists.";
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void requestProject(EventHandlerContext context) {
        ...
        Map valuesFiltered = filterWithPrefix(values, "project");
        ...
        String updateSql1 = "UPDATE project set status='Requested',date_requested="
        ...
        // @translatable
        String textDeptContact = localizeString(context,
        ...
        final String deptContact = getEmailAddress(context, getDepartmentContact(context, "",
            project_id));
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void withdrawProject(EventHandlerContext context) {
        ...
        Vector sqlCommands = new Vector();
        final String deleteProject = "DELETE FROM project WHERE project.project_id = "
                + literal(context, project_id) + " AND status = 'Created' ";
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void copyActionsToProject(EventHandlerContext context) {
        ...
        final String fields = getActivityLogFields(context,
            "copied_from;project_id;activity_log_id");

        if (this.log.isDebugEnabled()) {
            this.log.debug("fields=[" + fields + "]");
        }

        StringTokenizer ids = new StringTokenizer(activity_log_ids, ",");
        ...
        while (ids.hasMoreTokens()) {
            ...
            if (notNull(activity_log_id).length() != 0) {
                ...
                final String sqlInsert = "INSERT INTO activity_log (copied_from,project_id,"
                        + fields + ")" + " SELECT activity_log_id " + ","
                        + literal(context, project_id) + "," + fields
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void copyTemplateActionsToProject(EventHandlerContext context) {
        ...
        if (isOracle(context)) {
            strWorkPkgInsert = " INSERT INTO work_pkgs (project_id, work_pkg_id, summary, description, days_per_week, date_est_start, date_est_end) SELECT " 
                    + literal(context, project_id_destination)
                    + ", work_pkg_id, summary, description, days_per_week"
                    + ", (SELECT project.date_start FROM project WHERE project.project_id = " + literal(context, project_id_destination)
                    + ")  work_pkg_date_start, (SELECT project.date_end FROM project WHERE project.project_id = " + literal(context, project_id_destination)
            ...
            strWorkPkgInsert = " INSERT INTO work_pkgs (project_id, work_pkg_id, summary, description, days_per_week, date_est_start, date_est_end) SELECT " 
                    ...
                    + ", work_pkg_id, summary, description, days_per_week"
                    + ", (SELECT project.date_start FROM project WHERE project.project_id = " + literal(context, project_id_destination)
                    + ") AS work_pkg_date_start, (SELECT project.date_end FROM project WHERE project.project_id = " + literal(context, project_id_destination)
        ...
        String strInsert = "";
        if (isOracle(context)) {
            strInsert = " INSERT INTO activity_log (project_id,date_planned_for,date_scheduled," + fields + ")" + " SELECT "
            + literal(context, project_id_destination) 
            + ", (SELECT project.date_start FROM project WHERE project.project_id = " + literal(context, project_id_destination) 
            + ") project_date_planned_for, (SELECT project.date_start FROM project WHERE project.project_id = " + literal(context, project_id_destination) 
            ...
            strInsert = " INSERT INTO activity_log (project_id,date_planned_for,date_scheduled," + fields + ")" + " SELECT "
                + literal(context, project_id_destination) 
                + ", (SELECT project.date_start FROM project WHERE project.project_id = " + literal(context, project_id_destination) 
                + ") AS project_date_planned_for, (SELECT project.date_start FROM project WHERE project.project_id = " + literal(context, project_id_destination) 
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void rollUpActionCostsToProjects(EventHandlerContext context) {
        ...
        final String updateSQL = " UPDATE project SET " + " cost_est_baseline = " + " ( CASE WHEN "
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void createScenarioItemsFromActivityLogs(EventHandlerContext context) {
        ...
        WorkflowRulesContainer.Immutable container = getWorkflowRulesContainer(context);
        WorkflowRule.Immutable workflowRule = container
            .getWorkflowRule("AbCommonResources-ActionService");
        ...
        if (isOracle(context)) {
            sqlInsert = "INSERT INTO projscns "
            ...
            sqlInsert = "INSERT INTO projscns "
                    ...
                    + "FROM activity_log WHERE project_id = " + literal(context, project_id)
                    + " AND date_planned_for IS NOT NULL "
                    + " AND NOT EXISTS (SELECT 1 FROM projscns "
                    + " WHERE projscns.project_id = activity_log.project_id "
                    + " AND projscns.proj_scenario_id = " + literal(context, project_scenario_id)
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void routeProjectForApproval(EventHandlerContext context) {
        /*
        ...
        Vector sqlCommands = new Vector();
        String updateSql1 = "UPDATE project set status = 'Requested-Routed' WHERE project.project_id = "
                + literal(context, project_id);
        ...
        // @translatable
        String text = "Please indicate your approval by clicking in the URL below and selecting from the action options that appear next to your name";
        text = localizeString(context, text);
        ...
        Object[] args = new Object[] { project_id };
    ...
    private void setApprovingManagersStatusGroup(EventHandlerContext context, String project_id) {
        ...
        List records = selectDbRecords(context, "project", new String[] { "apprv_mgr1",
        ...
        for (Iterator it = records.iterator(); it.hasNext();) {
            ...
            if (bApprove) {
                ...
                Vector sqlCommands = new Vector();
                final String updateProject = "UPDATE project SET status = 'Approved', date_approved = "
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void approveProject(EventHandlerContext context) {
        ...
        if (isOracle(context)) {
            ...
            updateProject = "BEGIN UPDATE project SET " + status_field + " = 'A', " + date_field
                    + " = " + getCurrentDate(context) + " WHERE project.project_id = "
                    + literal(context, project_id) + "; COMMIT; END;";

        } else {

            updateProject = "UPDATE project SET " + status_field + " = 'A', " + date_field + " = "
                    + getCurrentDate(context) + " WHERE project.project_id = "
                    + literal(context, project_id);
        ...
        Object[] args = new Object[] { project_id, em_em_id };
        ...
        final String deptContact = getEmailAddress(context, getDepartmentContact(context, "",
            project_id));
        final String projectManager = getEmailAddress(context, getProjectManager(context,
            project_id));
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void rejectProject(EventHandlerContext context) {
        ...
        Vector sqlCommands = new Vector();
        final String updateProject = "UPDATE project SET " + status_field
     ...
     * 
     */
    public void copyScenarioRecordsToProjectFunds(EventHandlerContext context) {
        ...
        String description = "Copied from scenario: " + ProjScenarioId;
        String sql = "INSERT INTO projfunds (project_id, fund_id, fiscal_year, amount_cap, amount_exp, description) "
                ...
                + literal(context, ProjScenarioId)
                + " AND project_id = "
     ...
     *@exception ExceptionBase Description of the Exception
     */
    public void generateProgramBudget(EventHandlerContext context) {
        /*
        ...
        String strFromYear = (String) context.getParameter("from_year");
        String strToYear = (String) context.getParameter("to_year");
        ...
        boolean updateBudgetItems = StringUtil.toBoolean(context.getParameter("updateBudgetItems"));
        ...
        String sqlDelete = "DELETE FROM prog_budget_items WHERE budget_id="
                + literal(context, budget_id) + " AND (fiscal_year NOT IN (" + year_list + ")";
        ...
        for (int year = from_year.intValue(); year <= to_year.intValue(); year++) {
            ...
            // A. Create records from programs:
            String sqlInsert = " INSERT INTO prog_budget_items (budget_id,program_id,fiscal_year,cost_budget_cap,cost_budget_exp)"
                    + " SELECT "
                    + literal(context, budget_id)
                    + ",program_id,"
                    + year
                    + ",0.0,0.0"
                    + " FROM program WHERE status=1";
            if (sites) {
        ...
        if (updateBudgetItems) {
            String sqlUpdateTemplate = " FROM program, project, projfunds"
            ...
            if (sites) {
                sqlUpdateTemplate += " AND program.site_id IN " + sites_list + "  "
                        + " AND project.site_id IN " + sites_list + "  ";
            }
            if (programTypes) {
                sqlUpdateTemplate += " AND program_type IN " + program_type_list;
            }

            sqlUpdateTemplate = sqlUpdateTemplate
                    + " GROUP BY project.program_id, projfunds.fiscal_year), 0 ";

            String sqlUpdate = "";
            if (isOracle(context)) {
                sqlUpdate = " UPDATE prog_budget_items SET source='Projects',"
