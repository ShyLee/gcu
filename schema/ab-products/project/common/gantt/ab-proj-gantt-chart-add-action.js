var projGanttChartAddActionController = View.createController('projGanttChartAddAction', {
	...
	afterInitialDataFetch: function() {
		...
		if (openerController.is_mc) {
			var mcController = View.getOpenerView().getOpenerView().controllers.get('projManageConsole');
			this.projGanttChartAddActionForm.setFieldValue('activity_log.project_id', mcController.project_id);
