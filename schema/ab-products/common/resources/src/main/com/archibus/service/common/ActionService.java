...
public class ActionService extends EventHandlerBase {
    ...
    public void calcActivityLogDateSchedEndForActivity(EventHandlerContext context) {
        ...
        String activity_log_id = (String) context.getParameter("activity_log_id");
    ...
    public void calcActivityLogDateSchedEndForWorkPkg(EventHandlerContext context) {
        ...
        if (days_per_week != null) {
            String days = days_per_week.toString();
            String updateSQL = updateDateStatement(context, days, false);
            // UPDATE statement for activity_logs WITH work_pkgs
            String where = " WHERE project_id = " + literal(context, project_id)
    ...
    public void calcActivityLogDateSchedEndForProject(EventHandlerContext context) {
        ...
        String days = " (SELECT days_per_week FROM project WHERE project.project_id = activity_log.project_id )";
        String updateSQL = updateDateStatement(context, days, false);
        // UPDATE statement for activity_logs WITHOUT work_pkgs
        String where = " WHERE project_id LIKE " + project_id_value + " AND work_pkg_id IS NULL ";
