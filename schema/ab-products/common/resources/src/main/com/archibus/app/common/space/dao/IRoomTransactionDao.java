...
public interface IRoomTransactionDao extends IDao<RoomTransaction> {
     ...
     * @return List of RoomTransaction objects.
     */
    List<RoomTransaction> findPrimaryForRoom(Room room, Date dateTime);
     ...
     * @return List of RoomTransaction objects.
     */
    List<RoomTransaction> findPrimaryForEmployee(Employee employee, Date dateTime);
     ...
     * @return List of RoomTransaction objects.
     */
    List<RoomTransaction> findNoPrimaryForEmployee(Employee employee, Date dateTime);
     ...
     * @return List of RoomTransaction objects.
     */
    List<RoomTransaction> findEmLocationChange(final Employee employee, final Date dateTime);
     ...
     * @return List of RoomTransaction objects.
     */
    List<RoomTransaction> findEmDepartmentChange(final Employee employee, final Date dateTime);
     ...
     * @return List of RoomTransaction objects.
     */
    List<RoomTransaction> findRoomAttributeChange(Room room, Date dateTime);
