...
public class HighlightPatternService extends EventHandlerBase {
    ...
    public void createHatchPatterns(final String tableName, final String highlightPatternField,
            final boolean useOnlyColors, final String sortField, final boolean onlyUpdateIfNull) {
            ...
            for (final DataRecord record : records) {
                ...
                if (sortValue == null
                    ...
                    if (i < FIXEDCOLORS.length) {
                        ...
                        baseColor =
                                Integer.parseInt(FIXEDCOLORS[i % FIXEDCOLORS.length].substring(2),
                                    16) + 32;
                    }
                ...
                if (!(onlyUpdateIfNull && record.getValue(tableName + "." + highlightPatternField) != null)) {
            ...
            for (final DataRecord record : records) {
                ...
                if (useOnlyColors) {
                    ...
                    if (i < hatchPatterns.size()) {
                        hlPat.setRgbColor(new Color(Integer.parseInt(FIXEDCOLORS[i
                                % FIXEDCOLORS.length].substring(2), 16)));
                        ...
                        hlPat.setRgbColor(new Color(Integer.parseInt(FIXEDCOLORS[(i + tmp)
                                % FIXEDCOLORS.length].substring(2), 16)));
    ...
    public void clearHatchPatternLegends(final String tableName, final String hPatternField,
        ...
        if (fieldDef.getArchibusFieldType() != ArchibusFieldType.HIGHLIGHT_PATTERN_ACAD
                && fieldDef.getArchibusFieldType() != ArchibusFieldType.HIGHLIGHT_PATTERN_ACAD_EXT) {
            // @non-translatable
    ...
    public void createHatchPatternLegends(final String tableName, final String hPatternField,
        ...
        final String legendPath =
                HighLightUtilities
                    .getLocalPath(ContextStore.get().getProject().getGraphicsFolder()) + '/';
