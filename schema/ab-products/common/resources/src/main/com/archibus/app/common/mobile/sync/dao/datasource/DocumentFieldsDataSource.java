...
public class DocumentFieldsDataSource implements IDocumentFieldsDao {
    ...
    /**
     * Checks-in content of document field fieldName supplied in the record into table tableName.
     * 
    ...
    void checkInDocumentField(final String tableName, final String fieldName,
        ...
        if (!StringUtil.isNullOrEmpty(fileName)) {
            ...
            this.documentService.checkinNewFile(inputStream, keys, tableName, fieldName, fileName,
                "Document from mobile device.", UNLOCKED);
        }
    }
     ...
     * @param fileName of the document to be checked-in.
     */
