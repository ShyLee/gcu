...
public class SvgReportTest extends EventHandlerTestBaseImpl {
     ...
     * VIEWFILENAME2.
     */
    private static final String VIEWFILENAME2 = "ab-ex-eqxeqstd.axvw";
    ...
    public void testProcessAssets() throws IOException {
        ...
        svgReport.processAsset(
            DataSourceFactory.loadDataSourceFromFile(VIEWFILENAME2, "ds_abApEqPlans_drawing"),
            DataSourceFactory.loadDataSourceFromFile(VIEWFILENAME2, "ds_abApEqPlans_drawingLabel"),
            "eq", 0.00, null);
        Assert.assertNotNull(svgReport.getSvgDocument());
    }
