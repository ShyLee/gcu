...
var defineLocRMController = View.createController('defineLocationRM', {
    ...
    refreshTreeview: function(){
        ...
        if (siteId) {
            ...
            this.site_tree.addParameter('siteOfNullRm', " site.site_id ='" + siteId + "'");
        }
        else {
        ...
        if (buildingId) {
            ...
            this.site_tree.addParameter('blOfNullRm', " bl.bl_id ='" + buildingId + "'");
        }
        else {
            this.site_tree.addParameter('blId', "IS NOT NULL");
        ...
        if (floorId) {
            ...
            this.site_tree.addParameter('flOfNullRm', " fl.fl_id ='" + floorId + "'");
        }
        else {
            this.site_tree.addParameter('flId', "IS NOT NULL");
        ...
        if (roomId) {
            this.site_tree.addParameter('rmId', " = '" + roomId + "'");
            this.site_tree.addParameter('siteOfNullBl', " 1=0 ");
            this.site_tree.addParameter('blOfNullFl', " 1=0 ");
