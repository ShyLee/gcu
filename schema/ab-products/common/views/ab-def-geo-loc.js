var ctrlAbDefGeoLoc = View.createController('ctrlAbDefGeoLoc',{
	...
	refreshTree: function(){
		...
		if(geo_region_id){
			this.objTree.addParameter("geographic_region_id", "geo_region.geo_region_id = '" + geo_region_id + "'" );
		}else{
		...
		if(ctry_id){
			this.objTree.addParameter("country_id", "ctry.ctry_id = '" + ctry_id + "'" );
		...
		if(regn_id){
			this.objTree.addParameter("region_id", "regn.regn_id = '" + regn_id + "'" );
		...
		if(state_id){
			this.objTree.addParameter("state_id", "state.state_id = '" + state_id + "'" );
		...
		if(city_id){
			this.objTree.addParameter("city_id", "city.city_id = '" + city_id + "'" );
		...
		if(site_id){
			this.objTree.addParameter("site_id", "site.site_id = '" + site_id + "'" );
