...
var defDvDpController = View.createController('defDvDp', {
    ...
    dp_detail_afterRefresh: function(){
        this.dp_detail.enableField("dp.hpattern_acad", false);
        var field = this.dp_detail.fields.get("dp.hpattern_acad");
        if (field != null) {
    ...
    dv_detail_afterRefresh: function(){
        this.dv_detail.enableField("dv.hpattern_acad", false);
        var field = this.dv_detail.fields.get("dv.hpattern_acad");
        if (field != null) {
            field.actions.each(function(action){
                action.enable(true);
            });
    ...
    refreshTreeview: function(){
        ...
        if (businessId) {
            this.bu_tree.addParameter('buId', " bu.bu_id ='" + businessId + "'");
            this.bu_tree.addParameter('buOfNullDv', " bu.bu_id ='" + businessId + "'");
            this.bu_tree.addParameter('buOfNullDp', " bu.bu_id ='" + businessId + "'");
        }
        else {
        ...
        if (divisionId) {
            this.bu_tree.addParameter('dvId', " = '" + divisionId + "'");
            this.bu_tree.addParameter('dvOfNullDp', " dv.dv_id ='" + divisionId + "'");
        ...
        if (deptId) {
            this.bu_tree.addParameter('dpId', " = '" + deptId + "'");
            this.bu_tree.addParameter('buOfNullDv', " 1=0 ");
