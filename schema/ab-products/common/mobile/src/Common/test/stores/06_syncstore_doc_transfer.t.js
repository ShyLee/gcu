StartTest(function(t) {
    ...
    t.requireOk('Maintenance.store.WorkRequests', 'Maintenance.model.WorkRequest',
            ...
            'Common.util.UserProfile', 'Common.service.workflow.Workflow', function() {

                var workRequestStore = Ext.create('Maintenance.store.WorkRequests');
                var tableDefsStore = Ext.create('Common.store.TableDefs');
                var userProfilesStore = Ext.create('Common.store.UserProfiles');
                 ...
                 */
                var executeWorkFlowRules = function() {
                    var session = Ext.create('Common.Session'), userName = ConfigFileManager.username, userProfile = UserProfile
                            .getUserProfile();
