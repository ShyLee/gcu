...
StartTest(function(t) {
	...
	t.requireOk('Maintenance.model.WorkRequest', 'Maintenance.model.WorkRequestCraftsperson',
			...
			function() {
				...
				var workRequestCraftsperson = Ext.create('Maintenance.model.WorkRequestCraftsperson');
				...
				var workRequestCraftspersonsStore = Ext.getStore('workRequestCraftspersonsStore');

				workRequestCraftspersonsStore.add(workRequestCraftsperson);

				var async = t.beginAsync(40000);
