StartTest(function (t) {
    t.requireOk('Common.model.ModelBase', function () {
        ...
        t.throwsOk(function () { testModel.set('timeField', 'invalid'); }, /type/, 'Invalid type exception thrown');

        t.throwsOk(function () { testModel.set('timeField', 10023); }, /type/, 'Invalid type exception thrown');
