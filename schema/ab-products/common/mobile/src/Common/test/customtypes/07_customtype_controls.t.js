StartTest(function (t) {
    ...
    t.requireOk('Common.controls.NumberField', 'Common.model.ModelBase','Common.controls.TimePicker',
            'Common.controls.TimePickerField', 'Common.test.views.customtype_view', function () {
        ...
        var intfld = Ext.create('Common.controls.NumberField', {
            name: 'intfld',
            label: 'IntegerClass',
            decimals: 0
        });
        ...
        var timefld = Ext.create('Common.controls.TimePickerField', {
            name: 'timefld',
            label: 'TimeClass'
            //value: new Date()
        });
        ...
        // Retreive the record from the view
