...
Ext.define('Common.security.Security', {
	requires : [ 'Common.security.Password', 'Common.security.PermutationGenerator' ],
	...
	encypher : function(permutation) {
        console.log('Security: encypher text: [' + this.text + ']');
		var encypherString = '',
	...
	encryptString : function(stringToEncrypt) {
        var me = this;
        console.log('Security encryptString stringToEncrypt: [' + stringToEncrypt + ']');
