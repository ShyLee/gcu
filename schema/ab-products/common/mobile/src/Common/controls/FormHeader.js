 ...
 * @since 21.1
 */
Ext.define('Common.controls.FormHeader', {
	...
	getWorkRequestText : function(config) {
		var displayLabels = this.getDisplayLabels(), workRequestLabel = this.getWorkRequestLabel(), workRequestText;
	...
	getDateText : function(dateString) {
		var displayLabels = this.getDisplayLabels(), dateLabel = this.getDateLabel(), dateText;
