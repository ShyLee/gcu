...
Ext.define('Common.type.Timestamp', {
	...
	applyValue : function(newValue, oldValue) {
		var timeStampValue = null, value = newValue;
		...
		if (Ext.isDate(newValue)) {
			...
			if (this.dashesRegEx.test(value)) {
			...
			if (!isNaN(parsedDate)) {
				...
				throw new Error('The input value cannot be converted to a Common.type.Timestamp type.');
			}
		}
