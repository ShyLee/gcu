...
Ext.dom.Element.override({
    ...
    /**
     * 05.17.2013 Framework bug. The el variable is not checked in the original code. This bug
     * causes errors in Android. The fix is to check if the el variable exists before checking the
