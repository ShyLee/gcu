 ...
 * 
 */
public class ComplianceNotifyHelperTest extends DataSourceTestBase {
    ...
    public static void testCreateNotifications() {
        ...
        ComplianceNotifyHelper.createNotifications(String.valueOf(eventId));
    ...
    public final void testAssignNotifyTemplatesForNull() {
        ...
        final ComplianceNotifyHelper c = new ComplianceNotifyHelper();
    ...
    public static final void testFillRegLocInformationToEvent() {
        ...
        ComplianceNotifyHelper.fillRegLocInformationToEvent(compRecord, eventRecord);
        eventDs.saveRecord(eventRecord);
        
        final ParsedRestrictionDef restriction = new ParsedRestrictionDef();
        restriction.addClause(Constant.ACTIVITY_LOG, Constant.LOCATION_ID, nine, Operation.EQUALS);
        restriction.addClause(Constant.ACTIVITY_LOG, Constant.ACTIVITY_LOG_ID, ersanwuwu,
            Operation.EQUALS);
