 ...
 */
public class ComplianceLocationsHelper {
     ...
     * 
     */
    public ComplianceLocationsHelper() {
     ...
     */
    public List<DataRecord> chkDupLocations(final JSONObject record,
    ...
    public void createReglocRecordsForLocationList(final List<DataRecord> records,
        ...
        for (int i = 0; i < locations.length(); i++) {
            ...
            if (!this.chkDupLocations(record, location, type, -1).isEmpty()) {
                continue;
            }
