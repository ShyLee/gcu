...
public class ComplianceUtility extends JobBase {
    ...
    public static DataSource getDataSourceEvent() {
        return DataSourceFactory.createDataSourceForFields("activity_log", new String[] {
                "activity_log_id", "activity_log.regulation", "activity_log.reg_program",
                ...
                "activity_log.satisfaction_notes" });
    }
