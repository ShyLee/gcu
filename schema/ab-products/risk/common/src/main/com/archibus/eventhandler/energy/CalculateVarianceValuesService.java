...
public class CalculateVarianceValuesService {
    ...
    protected static void calcExpenseVarianceMonthORACLE(final String billId, final String vnId) {
        final String SQL =
                ""
                        + "UPDATE bill "
                        + "SET    bill.expense_variance_month = "
                        + "       (SELECT "
                        + "               CASE "
                        + "                       WHEN "
                        + "                               ( "
    ...
    protected static void calcExpenseVarianceMonthSQL(final String billId, final String vnId) {
        final String SQL =
                ""
                        ...
                        + "       AND     curr.vn_id                = ${parameters['vnId']} "
                        + "       ) " + "       a "
                        + "WHERE  bill.expense_variance_month <> a.expense_variance_month "
                        + "AND    bill.bill_id                 = ${parameters['billId']} "
                        + "AND    bill.vn_id                   = ${parameters['vnId']}";
    ...
    protected static void calcExpenseVarianceYearORACLE(final String billId, final String vnId) {
        final String SQL =
                ""
                        + "UPDATE bill "
                        + "SET    bill.expense_variance_year = "
                        + "       (SELECT "
                        + "               CASE "
                        + "                       WHEN "
                        + "                               ( "
    ...
    protected static void calcExpenseVarianceYearSQL(final String billId, final String vnId) {
        final String SQL =
                ""
                        + "UPDATE bill "
                        + "SET    bill.expense_variance_year = a.expense_variance_year "
                        + "FROM   (SELECT "
                        + "               CASE "
                        + "                       WHEN "
                        + "                               ( "
                        ...
                        + "       AND     curr.vn_id                = ${parameters['vnId']} "
                        + "       ) " + "       a "
                        + "WHERE  bill.expense_variance_year <> a.expense_variance_year "
                        + "AND    bill.bill_id                = ${parameters['billId']} "
                        + "AND    bill.vn_id                  = ${parameters['vnId']}";
    ...
    protected static void calcIncomeVarianceMonthORACLE(final String billId, final String vnId) {
        final String SQL =
                ""
                        + "UPDATE bill "
                        + "SET    bill.income_variance_month = "
                        + "       (SELECT "
                        + "               CASE "
                        + "                       WHEN "
                        + "                               ( "
    ...
    protected static void calcIncomeVarianceMonthSQL(final String billId, final String vnId) {
        final String SQL =
                ""
                        + "UPDATE bill "
                        + "SET    bill.income_variance_month = a.income_variance_month "
                        + "FROM   (SELECT "
                        + "               CASE "
                        + "                       WHEN "
                        + "                               ( "
                        ...
                        + "       AND     curr.vn_id                = ${parameters['vnId']} "
                        + "       ) " + "       a "
                        + "WHERE  bill.income_variance_month <> a.income_variance_month "
                        + "AND    bill.bill_id                = ${parameters['billId']} "
                        + "AND    bill.vn_id                  = ${parameters['vnId']}";
    ...
    protected static void calcIncomeVarianceYearSQL(final String billId, final String vnId) {
        final String SQL =
                ""
                        + "UPDATE bill "
                        + "SET    bill.income_variance_year = a.income_variance_year "
                        + "FROM   (SELECT "
                        + "               CASE "
                        + "                       WHEN "
                        + "                               ( "
                        ...
                        + "       AND     curr.vn_id                = ${parameters['vnId']} "
                        + "       ) " + "       a "
                        + "WHERE  bill.income_variance_year <> a.income_variance_year "
                        + "AND    bill.bill_id               = ${parameters['billId']} "
                        + "AND    bill.vn_id                 = ${parameters['vnId']}";
