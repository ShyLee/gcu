...
public class RegressionUtilService {
     ...
     * @throws RuntimeException
     */
    public static RealVector getResiduals(final RealMatrix X, final RealVector Y, final RealVector B)
            throws RuntimeException {
        RealVector E;
    ...
    static RealVector getMeasurementVector(final List<DataRecord> series,
        ...
        for (final DataRecord point : series) {
            consumption =
                    Double.parseDouble(point.getValue("energy_bl_svc_period.consumption")
                        .toString());
            ...
            if (measurement == null) {
                // @translatable
                final String msg1 = "Missing " + measurementType + " data";
                throw new ExceptionBase(msg1);
            }
