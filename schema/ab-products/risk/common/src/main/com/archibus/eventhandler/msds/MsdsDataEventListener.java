...
public class MsdsDataEventListener implements IDataEventListener {
    ...
    /**
     * Constant: Table name: "msds_locations".
     */
    private static final String MSDS_LOCATION = "msds_location";
    
    /**
     * Constant: Table name: "msds_h_locations".
     */
    private static final String MSDS_H_LOCATION = "msds_h_location";
    
    /**
     * Constant: Table name: "msds_haz_classification".
     */
    private static final String MSDS_HAZ_CLASSIFICATION = "msds_haz_classification";
    
    /**
     * Constant: Table name: "msds_h_haz_classification".
     */
    private static final String MSDS_H_HAZ_CLASSIFICATION = "msds_h_haz_classification";
    
    /**
     * Constant: Table name: "msds_constituent".
     */
    private static final String MSDS_CONSTITUENT = "msds_constituent";
    
    /**
     * Constant: Table name: "msds_h_constituent".
     */
    private static final String MSDS_H_CONSTITUENT = "msds_h_constituent";
    
    /**
     * Constant: Table name: "msds_chemical".
     */
    private static final String MSDS_CHEMICAL = "msds_chemical";
    
    /**
     * Constant: Table name: "msds_h_chemical".
     */
    private static final String MSDS_H_CHEMICAL = "msds_h_chemical";
    
    /**
     * Constant: Table-Field name: "msds_chemical.chemical_id".
     */
    private static String[] msdsTables = { MSDS_DATA, MSDS_LOCATION, MSDS_HAZ_CLASSIFICATION,
            MSDS_CONSTITUENT, MSDS_CHEMICAL };
    
    /**
     * Constant: Table-Field name: "msds_chemical.chemical_id".
     */
    private static String[] msdsHistoryTables = { MSDS_H_DATA, MSDS_H_LOCATION,
            MSDS_H_HAZ_CLASSIFICATION, MSDS_H_CONSTITUENT, MSDS_H_CHEMICAL };
    ...
    private void onApplicationEventRecordChanged(final RecordChangedEvent recordChangedEvent) {
        ...
        for (String msdsTable : msdsTables) {
    ...
    private void insertMsdsHistoryRecord(final DataRecord eventRecord, final String tableName) {
        ...
        for (String hisFieldName : hisFieldsNameList) {
            
            if (record.valueExists(tableName + DOT + hisFieldName)) {
                
                hisRecord.setValue(hisTableName + DOT + hisFieldName,
                    record.getValue(tableName + DOT + hisFieldName));
            }
        }
    ...
    private DataRecord getHistoryRecord(final String tableName, final String hisTableName,
        ...
        currentTime.setTime(currentTime.getTime() / MILLISECONDS * MILLISECONDS);
    ...
    private ParsedRestrictionDef getPrimaryKeyRestriction(final String tableName,
        ...
        hisRestriction.addClause(hisTableName, DATE_ARCHIVED, Utility.currentDate(),
            Operation.EQUALS);
        hisRestriction.addClause(hisTableName, TIME_ARCHIVED, currentTime, Operation.EQUALS);
    ...
    private void addPkClausesToRestriction(final String srcTableName, final String destTableName,
        ...
        for (String keyFieldName : pkNames) {
    ...
    private Object getPrimaryKeyValue(final DataSource dataSource, final String tableName,
        ...
        if (record.valueExists(tableName + DOT + fieldName)) {
            
            value = record.getValue(tableName + DOT + fieldName);
            ...
            final ParsedRestrictionDef restriction = new ParsedRestrictionDef();
            for (DataRecordField dbf : record.getFieldValues()) {
            ...
            if (!records.isEmpty()) {
                value = records.get(0).getValue(tableName + DOT + fieldName);
            }
