...
//			check if it's coordinator model. use for 'Manage My Permits and Licenses'  and  'Manage My Compliance Requirements'
			if(this.mainController.isCoordinator&&this.mainController.isCoordinator==true){
			  	this.regLocGridForRequirement.actions.get("addNew").show(false);
			}
	...
	regLocGrid_onAddNew:function(){
		this.invokeAddNew();
	},
	regLocGridForProgram_onAddNew:function(){
		this.invokeAddNew();
	},
	regLocGridForRequirement_onAddNew:function(){
		this.invokeAddNew();
	},
	/**
...
//		 There is no way to use the tab again unless you reload the view.
	...
	* Event Handler of action "Doc"
	*/
	regLocGridForProgram_onDoc : function(){
		var	parameters = {};
		parameters.selectRes = this.selectRes;
	...
	* Event Handler of action "Doc"
	*/
	regLocGridForRequirement_onDoc : function(){
		var	parameters = {};
		parameters.selectRes = this.selectRes;
