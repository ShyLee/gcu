var mainController = commonRptController.extend({
	...
	getCrossTableSql:function(restriction,groupClause){
		...
		crosstable = crosstable.replace(/ACTIVITY-SUB-QUERY-RESTRICTION/g, mainController.activitySubQueryRes);
		crosstable = crosstable.replace(/DOC-SUB-QUERY-RESTRICTION/g,mainController.assignDocSubQueryRes);
		crosstable = crosstable.replace(/REGVIOLATION-SUB-QUERY-RESTRICTION/g,mainController.regviolationSubQueryRes);
		return crosstable;
	},
	...
	onPaginatedReport: function(commandObject, pagRepName){
		var parameters = {
	        ...
	        'printableRestriction': mainController.abConsoleController.printableRestriction
	    };
	 ...
	 */
	abCbRptDrilldown_panelRegulation_onView: function(row){
	 ...
	 */
	abCbRptDrilldown_panelProgram_onView: function(row){
	 ...
	 */
	abCbRptDrilldown_panelRequirement_onView: function(row){
	...
	/**
	 * Event handler function ,print paginate report.
	 */
	onPaginatedReport: function(commandObject, pagRepName){
		var parameters = {
	        'consoleRestriction': commandObject.getParentPanel().restriction
