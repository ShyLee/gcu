var abGbFpDataS3EmpTransAir_ctrl = View.createController('abGbFpDataS3EmpTransAir_ctrl', {
	...
	setFieldsStyle: function(){
		this.abGbFpDataS3EmpTransAir_methodology.getFieldLabelElement("field_CO2Emissions").style.fontWeight = "bold";
		this.abGbFpDataS3EmpTransAir_methodology.getFieldLabelElement("field_NonCO2Emissions").style.fontWeight = "bold";
		this.abGbFpDataS3EmpTransAir_methodology.getFieldLabelElement("gb_fp_s3_em_air.kg_co2").style.fontWeight = "bold";
		this.abGbFpDataS3EmpTransAir_methodology.getFieldLabelElement("gb_fp_s3_em_air.emissions").style.fontWeight = "bold";

		for (var i = 1; i <= 2; i++) {
			var fld = document.getElementById("ShowabGbFpDataS3EmpTransAir_methodology_field_empty_" + i);
