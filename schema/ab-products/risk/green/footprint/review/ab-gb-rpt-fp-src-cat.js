...
var abGbRptFpSrcCatCtrl = View.createController('abGbRptFpSrcCatCtrl', {
	...
	scope2Columns : {'gb_fp_totals.s2_purch_e': true,'gb_fp_totals.vf_s2_purch_e': true},
	
	scope3Columns : {'gb_fp_totals.s3_cont': true, 'gb_fp_totals.s3_em_air': true, 'gb_fp_totals.s3_em_rail': true, 'gb_fp_totals.s3_em_road': true,
	        		'gb_fp_totals.s3_mat': true, 'gb_fp_totals.s3_outs': true, 'gb_fp_totals.s3_serv': true, 'gb_fp_totals.s3_waste_liq': true,
	        		'gb_fp_totals.s3_waste_sol': true, 'gb_fp_totals.vf_s3_total': true, 'gb_fp_totals.vf_s3_waste_total': true, 'gb_fp_totals.vf_s3_em_total': true,
	        		'gb_fp_totals.vf_s3_cont': true, 'gb_fp_totals.vf_s3_em_air': true, 'gb_fp_totals.vf_s3_em_rail': true, 'gb_fp_totals.vf_s3_em_road': true,
	...
	otherColumns : {'gb_fp_totals.s_other': true,'gb_fp_totals.vf_s_other': true},
	...
	siteGridFlds_statConfig: {
		formulas: ["sum"],
		fields: ["gb_fp_totals.vf_s1_total","gb_fp_totals.s1_fuel_comb","gb_fp_totals.s1_co_road",
		         "gb_fp_totals.s1_co_airc","gb_fp_totals.vf_s1_co_transp","gb_fp_totals.s1_refrig_airc",
		         "gb_fp_totals.s2_purch_e","gb_fp_totals.vf_s3_total","gb_fp_totals.s3_waste_sol",
		         "gb_fp_totals.s3_waste_liq","gb_fp_totals.vf_s3_waste_total","gb_fp_totals.s3_em_road",
		         "gb_fp_totals.s3_em_rail","gb_fp_totals.s3_em_air","gb_fp_totals.vf_s3_em_total",
		         "gb_fp_totals.s3_mat","gb_fp_totals.s3_cont","gb_fp_totals.s3_outs","gb_fp_totals.s3_serv",
		         "gb_fp_totals.s_other","gb_fp_totals.vf_cf_bldg_count","gb_fp_totals.vf_bldg_count"]
	},
	...
	abGbRptFpSrcCat_site_afterRefresh: function(){
		this.setTotalColTitle(this.abGbRptFpSrcCat_site);
	},

	abGbRptFpSrcCat_bl_afterRefresh: function(){
		this.setTotalColTitle(this.abGbRptFpSrcCat_bl);
	},
