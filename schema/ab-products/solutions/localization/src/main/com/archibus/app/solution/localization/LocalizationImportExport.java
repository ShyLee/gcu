...
public class LocalizationImportExport extends LocalizationBase {
     ...
     */
    public void exportExtractFiles(String language, String stringsToInclude, String format,
            String dbExtension) {
        
        // create restrictions for each localization table
        String langRest = "language = '" + language + "'";
     ...
     */
    public void exportGlossaryFiles(String language, String stringsToInclude, String format,
            String dbExtension) {
     ...
     * @return None
     */
    private String exportTable(String viewFile, String ds, String panelFields, String title,
            String table, String fileName, String format, String restriction) {
        
        try {
            DataSource dataSource = DataSourceFactory.loadDataSourceFromFile(viewFile, ds);
            dataSource.setContext();
            dataSource.setMaxRecords(0);
            
            // retrieve a list of field names to transfer out.
            List<Map<String, String>> panelFieldsList =
                    DataTransferUtility.getPanelFeldsList(dataSource);
            List<String> visibleFieldsFromMainTable =
            ...
            String filePath = FileHelper.getDefaultStorePath("") + validatedFileName;
