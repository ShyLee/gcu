...
public class LocalizationRead extends LocalizationBase {
    ...
    public void readTranslatableFiles(final String language, String activityDir,
            ...
            final Boolean bMnu, final Boolean bCore) {
    ...
    private void addCoreStrings() {
        ...
        insertTranslatableFileString(this.language, "9", "com.archibus.db.HandlerSqlException",
            "This can be caused by a Division by zero error.");
        ...
        insertTranslatableFileString(this.language, "3",
            "com.archibus.model.view.report.panel.PanelDefLoader",
            "Report definition contains [{0}] legend panels. Maximum of 1 legend panels is allowed.");
        insertTranslatableFileString(this.language, "4",
            "com.archibus.model.view.report.panel.PanelDefLoader",
        ...
        insertTranslatableFileString(
            this.language,
            "1",
            "com.archibus.model.licensing.processor.CheckActivityToDomainReassignment",
        ...
        insertTranslatableFileString(
            ...
            "2",
            "com.archibus.model.licensing.processor.CheckViewRenderingRequest",
            "The program will not load view [{1}] as it belongs to a domain or activity not licensed at this site");
        insertTranslatableFileString(this.language, "1",
        ...
        insertTranslatableFileString(this.language, "3",
            "com.archibus.ext.report.ReportBuilderJob",
            "Fail to export a Grid XLS report with a view name [%s] and a data source id [%s]");
        insertTranslatableFileString(this.language, "4",
        ...
        insertTranslatableFileString(this.language, "1",
            ...
            "Navigation Pages successfully published for");
        insertTranslatableFileString(this.language, "1",
            "com.archibus.ext.drawing.highlight.emf.EmfRendererUtilities",
            "Cannot acccess the entprise file named [%s]");
        insertTranslatableFileString(this.language, "1",
        ...
        insertTranslatableFileString(this.language, "1",
            "com.archibus.view.navigation.NavigationBucketUtilities", "ARCHIBUS APPLICATIONS");
        insertTranslatableFileString(this.language, "2",
            "com.archibus.view.navigation.NavigationBucketUtilities", "My Favorites");
        insertTranslatableFileString(this.language, "3",
            "com.archibus.view.navigation.NavigationBucketUtilities",
        ...
        while (elementIterator.hasNext()) {
            ...
            if (("true".equals(translatable))
                    || ((nodeName.equals("title") || nodeName.equals("message")
                            || nodeName.equals("tooltip") || nodeName.equals("instructions")) && !("false"
                        .equals(translatable)))) {
                insertTranslatableFileString(this.language,
    ...
    private void readAxvwXslJsp() {
        ...
        for (final Object element : this.axvwXslJspFiles) {
            ...
            try {
                searchForAxvwXslJspStrings(axvwXslJspFilePath);
            } catch (final Exception e) {
                e.printStackTrace();
            }
        }
     ...
     * @throws IOException
     */
    private void searchForAxvwXslJspStrings(final String srcFilePath) throws IOException {
        try {
            ...
            final Boolean legacyView =
                    (((root.selectNodes("//view[@version='2.0']").size() == 0) || (srcFilePath
                        .endsWith("xsl"))) && (!srcFilePath.endsWith("jsp")));
            if (legacyView) {
    ...
    private void searchForResxStrings(final String srcFilePath) throws IOException {
        try {
            ...
            for (final Iterator<Element> i = resxElementRoot.elementIterator("data"); i.hasNext();) {
