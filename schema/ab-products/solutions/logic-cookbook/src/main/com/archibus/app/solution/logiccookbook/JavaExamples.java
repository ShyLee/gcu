...
public class JavaExamples {
    ...
    public void useCollections() {
        ...
        for (final String buildingId : totalCostsByBuilding.keySet()) {
            ...
            // Simulate processing.
            final String message = MessageFormat.format("Building {0}: cost = {1}", buildingId,
                cost);
    ...
    public void useDataTypes(final double costOfLabor, final double costOfMaterials,
        ...
        final DataSource dataSource = DataSourceFactory.createDataSourceForFields(TABLE_COST_TRAN,
            new String[] { FIELD_COST_TRAN_ID, FIELD_AMOUNT_EXPENSE });
        ...
        for (final DataRecord cost : costs) {
            final BigDecimal amountExpense = new BigDecimal(cost.getDouble(TABLE_COST_TRAN + PERIOD
                    + FIELD_AMOUNT_EXPENSE));
            totalExpense = totalExpense.add(amountExpense);
        }
    }
    ...
    public List<Integer> useForLoop() {
        ...
        for (final DataRecord cost : costs) {
            final double amountExpense = cost.getDouble(TABLE_COST_TRAN + PERIOD
                    + FIELD_AMOUNT_EXPENSE);
    ...
    public void useGetAndUpdateRecordLoop() {
        ...
        final String[] fields = { "pct_id", "date_start", "date_end", FIELD_PCT_TIME,
                FIELD_PCT_SPACE, "day_part" };
