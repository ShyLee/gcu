...
public class LogicExampleHandlers extends JobBase {
    ...
    public void logProgressAndThrowException(final String woId) {
        ...
        } catch (ExceptionBase webCentralException) {
        ...
        try {
            ...
            final ExceptionBase exception =
                    ExceptionBaseFactory
                        .newNonTranslatableException(message, new Object[] { woId });
     ...
     * <ul>
     * <li>
     * Panel parameters for the data source.
     * <li>
     * Filter values.
     * <li>
     * Sort values.
    ...
    public final DataSetList getRecordsWithSupportForSortingAndFiltering(
        ...
        final DataSource dataSource =
                DataSourceFactory.loadDataSourceFromFile("ab-ex-prg-grid-custom-wfr.axvw",
                    "prgGridCustomWfr_gridDs");
    ...
    public DataSetList getRecordsWithCustomVpa(final Date dateFrom) {
        ...
        dataSource
            .addQuery("SELECT wo_id, wo_type, description, date_assigned, time_assigned, priority, bl_id "
    ...
    public void updateRecords(final DataSetList workOrders) {
        ...
        for (DataRecord record : workOrders.getRecords()) {
            dataSource.saveRecord(record);
        }
    }
    ...
    private DataSource createWorkOrderDataSource() {
        ...
        final String[] fieldNames =
                { FIELD_WO_ID, FIELD_WO_TYPE, FIELD_BL_ID, FIELD_DATE_ASSIGNED,
    ...
    public void verifyActions(final List<DataRecord> pkRecords) {
        for (DataRecord pkRecord : pkRecords) {
    ...
    public DataSet1D getWorkRequestChartData(final String restriction) {
        ...
        final DataSource dataSource =
                DataSourceFactory.loadDataSourceFromFile("ab-ex-custom-chart.axvw",
                    "customChart_requestDs");
    ...
    public DataSet1D getWorkRequestChartDataWithSql(final String restriction) {
        ...
        dataSource.addQuery(
            "SELECT fl_id, COUNT(wr_id) AS total_requests, SUM(cost_est_total) AS total_cost, "
                    ...
                    + "FROM wr WHERE bl_id = 'HQ' GROUP BY fl_id", SqlExpressions.DIALECT_GENERIC);
    ...
    public void saveEmployeeAndParking(final DataRecord employeeRecord,
        ...
        final DataSource employeeDataSource =
                DataSourceFactory.createDataSourceForFields("em", new String[] { "em_id", "em_std",
                        FIELD_DV_ID, FIELD_DP_ID }, false);
        final DataSource parkingDataSource =
                DataSourceFactory.createDataSourceForFields("parking", new String[] { "parking_id",
                        "parking_std", FIELD_BL_ID }, false);
    ...
    public String showPartsForOpenWorkRequests() throws ExceptionBase {
        ...
        for (DataRecord wrptRecord : wrptRecords) {
        ...
        for (DataRecord partRecord : partRecords) {
            ...
            message.append(MessageFormat.format(
                "Part = {0}, on hand before = {1}, on hand after = {2}<br/>", partId,
                quantityOnHandBefore, quantityOnHandAfter));
        }
    ...
    public void generatePmpSummary(final Date dateFrom, final Date dateTo) throws ExceptionBase {
        if (this.logger.isDebugEnabled()) {
            this.logger.debug("Generating pmpsum records from [" + dateFrom + "] to [" + dateTo
                    + "]");
        }
        ...
        final DataSource pmpDataSource =
                DataSourceFactory.createDataSourceForFields(TABLE_PMPSUM,
        ...
        String sql =
                "INSERT INTO pmpsum (date_todo, eq_id, pmp_id, tr_id, hours)"
    ...
    public String getFormattedValues(final String dateInput) throws ExceptionBase {
        ...
        final String message =
                MessageFormat.format(
                    "Neutral: {0}<br/>Object: {1}<br/>SQL: {2}<br/>Localized: {3}", parameters);
