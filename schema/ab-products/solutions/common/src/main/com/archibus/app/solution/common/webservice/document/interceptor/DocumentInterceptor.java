 ...
 * 
 */
public class DocumentInterceptor implements MethodInterceptor {
    ...
    private void uploadLeaseToSharepointServer(final InputStream inputStream,
        ...
        // @non-translatable
        final String operation = "Intercepting checkinNewFile or checkinNewVersion method: tableName=[%s], fieldName=[%s], documentName=[%s], keys=[%s]";
        
        if (this.logger.isInfoEnabled()) {
            final String message = String.format(operation, tableName, fieldName, documentName,
                keys);
