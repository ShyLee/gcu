...
public class CustomDrawingPanelBuilder extends
    ...
    public void processLegend(final PanelBuilderBase legendPBuilder, final Report report,
        ...
        final Shape legendShap = getTextBoxShape(body, "LEGENDTABLE");
        if (legendShap != null) {
    ...
    private Shape getTextBoxShape(final Body body, final String alternativeText) {
        Shape result = null;
        final NodeCollection<?> shapes = body.getChildNodes(NodeType.SHAPE, true, false);
    ...
    private String publishDrawing(final com.aspose.words.Document document,
        ...
        final double targetWidth = drawingShap.getWidth();
        final double targetHeight = drawingShap.getHeight();
