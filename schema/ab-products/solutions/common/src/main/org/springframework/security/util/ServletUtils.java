...
public final class ServletUtils {
     ...
     */
    public static Map<String, String> extractHeaderValues(HttpServletRequest request,
            List<String> keys) {
     ...
     */
    public static Map<String, String> extractCookiesValues(HttpServletRequest request,
            List<String> keys) {
        Assert.notNull(request);
        Assert.notNull(keys);
     ...
     */
    public static Map<String, String> extractParameterValues(HttpServletRequest request,
            List<String> keys) {
        Assert.notNull(request);
        Assert.notNull(keys);
