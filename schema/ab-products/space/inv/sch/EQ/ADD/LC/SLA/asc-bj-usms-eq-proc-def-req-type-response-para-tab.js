...
var image_path = "/" + current_view_path.substring(current_view_path.indexOf('archibus'), current_view_path.lastIndexOf('asc-bj-usms-eq-proc-def-req-type-response-para-tab.axvw')) + "graphics/";
