var controller = View.createController('controller', {	
	afterInitialDataFetch: function(){		
		...
		var columns = [];
		columns. push(new Ab.grid.Column('cat', '单位名称','text', null, null));
	...
	tablePanel_onReport: function(){
		View.openDialog('asc-bj-usms-select-fixed-rpt-format.axvw', null, false, {width:470, height:200, xmlName:"eqSourceChangeReport",closeButton:false});
	}
});