var controller=View.createController('csiForm',{
	...
	csiGridPanel_btnClick_onClick: function(row,action){
		...
		var parentFormPanel=parentForm.View.panels.get('budetItemDetailsPanel');
		parentFormPanel.setFieldValue('eq_budget_item.csi_id',csiId);
		parentFormPanel.setFieldValue('eq_budget_item.eq_name',eqName);
