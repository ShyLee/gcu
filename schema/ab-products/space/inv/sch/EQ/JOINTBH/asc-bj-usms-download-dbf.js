...
var controller = View.createController('mySingleJobReportController', {
	...
	afterViewLoad: function() {
		...
		//this.getURLParams();
		this.ruleId = unescape("AbAssetManagement-ExportDBFService-write");
		
	},
	
	afterInitialDataFetch: function() {
		var imgFieldZJ=document.getElementById("downLoadImgZJ");
		imgFieldZJ.src=View.getBaseUrl()+"/schema/ab-products/space/inv/sch/EQ/JOINTBH/ab-icon-download.png";
		var imgFieldBDK=document.getElementById("downLoadImgBDK");
		imgFieldBDK.src=View.getBaseUrl()+"/schema/ab-products/space/inv/sch/EQ/JOINTBH/ab-icon-download.png";
		var imgFieldDW=document.getElementById("downLoadImgDW");
		imgFieldDW.src=View.getBaseUrl()+"/schema/ab-products/space/inv/sch/EQ/JOINTBH/ab-icon-download.png";
		this.downloadFileLinkPanel.show(false);
		if(this.jobId != ''){
				...
				run: function(){
					...
					if(typeof controller.result != 'undefined'){
						...
						if(controller.result.jobFinished == true){
							...
							View.panels.get("downloadFileLinkPanel").show(true);
...
function downloadDBF(name,url){
	...
	downForm.action = View.getBaseUrl()+"/schema/ab-products/space/inv/sch/EQ/JOINTBH/FileDownLoad.jsp";
