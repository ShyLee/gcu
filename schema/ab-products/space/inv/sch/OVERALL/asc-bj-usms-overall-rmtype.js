 ...
 * @author Keven.xi
 */
var ascBjUsmsOverallRmType = View.createController('ascBjUsmsOverallRmTypeController', {
	...
	afterViewLoad: function(){
		...
		var ds = View.dataSources.get("ds_asc-bj-usms-overall-rmtype_tab_site");
...
function createSubCampusTab(level, subCampusTitle,siteId){
    ...
    var tab = new Ab.tabs.Tab({
        ...
        fileName: 'asc-bj-usms-overall-rmtype-main.axvw',
        selected: false,
        enabled: true,
        hidden: false,
    ...
    tab.siteId = siteId;
    ascBjUsmsOverallRmType.campusTabs.addTab(tab);
    tab.createTabPanel();
}
