 ...
 * @author Keven.xi
 */
var ascBjUsmsOverallBlYxz = View.createController('ascBjUsmsOverallBlYxzController', {
...
function createSubCampusTab(level, subCampusTitle,siteId){
    ...
    var tab = new Ab.tabs.Tab({
        ...
        fileName: 'asc-bj-usms-overall-bl-yxz-main.axvw',
        selected: false,
        enabled: true,
        hidden: false,
    ...
    tab.siteId = siteId;
    ascBjUsmsOverallBlYxz.campusTabs.addTab(tab);
    tab.createTabPanel();
}
