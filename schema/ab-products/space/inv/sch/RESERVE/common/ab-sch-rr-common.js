 ...
 */
function ABRV_getTimeColumn(timelineStartTime,minorSegments,timeOfDay,MaxTimemarksColumn) {
	var arrayTime = [];
	...
	columnAvailableFrom += Math.round(Math.ceil(resStartMin * minorSegments / 60));
