...
Ab.application.RoomTimeline = Base.extend({
	...
	createTimeline: function() {
		...
		this.timelineController.addColumn('info', "", 'image', this.viewRoomDetails.createDelegate(this), getMessage('info'), 'ab-sch-rr-info.gif');
		...
		this.timelineController.addColumn('approval', "", 'image', null, getMessage('approval'), 'ab-sch-rr-approval.gif');
		this.timelineController.addColumn('isDefault', "", 'image', null, getMessage('isDefault'), 'ab-sch-rr-isdefault.gif');
	},
