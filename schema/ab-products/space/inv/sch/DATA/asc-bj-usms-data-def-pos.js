...
var abScDefPostController = View.createController('abScDefPost', {
	...
	onAddNewButtonPush: function(menuItemId){
        ...
        switch (menuItemId) {
			...
			case "POSTION":
				 if (nodeLevelIndex == -1) {
	                    View.showMessage('请选择岗位级别');
	                    return;
	                }
                restriction.addClause("sc_zhiwu.gangweijibie_id", gangweijibie_id, '=');
...
function afterGeneratingTreeNode(treeNode){
    ...
    if (treeNode.level.levelIndex == 0) {
        ...
        labelText1 = "<span class='" + treeNode.level.cssClassName + "'>" + sc_gangweijibieCode + "</span> ";
