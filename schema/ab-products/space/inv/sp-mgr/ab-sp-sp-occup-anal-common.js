var abSpOccupAnalCommonController = View.createController('abSpOccupAnalCommonController', {
	...
	showDepartmentPlusChartCommon: function(){
		this.setParameters(this.abRmpctHrmpctDepartmentPlusChart);
		this.abRmpctHrmpctDepartmentPlusChart.refresh();
		this.abRmpctHrmpctDepartmentPlusChart.show(true);
		//TODO: according to selected group by option and calculation type, set proper titles to chart.
	},
