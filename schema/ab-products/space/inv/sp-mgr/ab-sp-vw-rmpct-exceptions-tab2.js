...
var abSpVwRmpctExceptionsController2 = View.createController('abSpVwRmpctExceptionsController2', {
	...
	afterInitialDataFetch: function(){
		$('abSpVwRmpctExceptionsConsole_field_gen1_labelCell').hidden=true;
		$('allocatedType').hidden=true;
		getExceptionsList();
...
function showTreeByExceptionType(fromWhere){
	...
	if(c.optionIndex==8){
		if(fromWhere==0){
			$('abSpVwRmpctExceptionsConsole_field_gen1_labelCell').hidden=false;
			$('allocatedType').hidden=false;
