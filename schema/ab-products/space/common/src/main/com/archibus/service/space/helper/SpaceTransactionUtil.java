...
public final class SpaceTransactionUtil {
    ...
    public static DataSource getActivityDataSource() {
        return DataSourceFactory.createDataSourceForFields(SpaceConstants.ACTIVITY_LOG,
            new String[] { SpaceConstants.ACT_QUEST, SpaceConstants.DESCRIPTION,
                    SpaceConstants.REQUESTOR, SpaceConstants.STATUS, SpaceConstants.ACTIVITY_TYPE,
                    SpaceConstants.DV_ID, SpaceConstants.DP_ID, SpaceConstants.ACTIVITY_LOG_ID,
    ...
    public static DataSource getAfmRulesDatasource() {
        return DataSourceFactory.createDataSourceForFields(SpaceConstants.AFM_ROLES,
    ...
    public static DataSource getEmDataSource() {
        return DataSourceFactory.createDataSourceForFields(SpaceConstants.T_EM, new String[] {
    ...
    public static DataSource getMoDataSource() {
        return DataSourceFactory.createDataSourceForFields(SpaceConstants.T_MO, new String[] {
                "date_created", "date_requested", "time_requested", "dept_contact", "description",
                "requestor", "mo_type", "status", "date_to_perform", "date_start_req", "to_bl_id",
                "to_fl_id", "to_rm_id", "em_id", "from_bl_id", "from_fl_id", "from_rm_id", "phone",
                "phone_dept_contact", "dv_id", "dp_id", "from_dv_id", "from_dp_id", "from_phone",
                "to_dv_id", "to_dp_id", "to_phone", "project_id", "activity_log_id"
    ...
    public static DataSource getRmDataSource() {
        return DataSourceFactory.createDataSourceForFields(new String[] { SpaceConstants.T_RM,
    ...
    public static DataSource getRmpctDataSource() {
        return DataSourceFactory.createDataSourceForFields(SpaceConstants.RMPCT, new String[] {
                SpaceConstants.PCT_ID, SpaceConstants.PARENT_PCT_ID, SpaceConstants.DATE_START,
                SpaceConstants.EM_ID, SpaceConstants.BL_ID, SpaceConstants.FL_ID,
                SpaceConstants.RM_ID, SpaceConstants.FROM_BL_ID, SpaceConstants.FROM_FL_ID,
                SpaceConstants.FROM_RM_ID, SpaceConstants.STATUS, SpaceConstants.ACTIVITY_LOG_ID,
                SpaceConstants.DV_ID, SpaceConstants.DP_ID, SpaceConstants.RM_CAT,
                SpaceConstants.RM_TYPE, SpaceConstants.USER_NAME, SpaceConstants.PRIMARY_EM,
                SpaceConstants.PRIMARY_RM, SpaceConstants.PCT_SPACE, SpaceConstants.PRORATE,
                SpaceConstants.DATE_END, SpaceConstants.MO_ID });
    ...
    public static DataSource getWfRulesDatasource() {
        return DataSourceFactory.createDataSourceForFields(SpaceConstants.AFM_WF_RULES,
