 ...
 * 
 * DBFField objects are either created and added to a DBFWriter object or obtained from DBFReader
 * object through getField( int) query.
 */
public class DBFField {
    
    public static final byte FIELD_TYPE_C = (byte) 'C';// 字符类型
    
    public static final byte FIELD_TYPE_L = (byte) 'L';// 逻辑类型
     ...
     * 
     * The data in the DataInputStream object is supposed to be organised correctly and the stream
     ...
     */
    protected static DBFField createField(final DataInput in) throws IOException {
    ...
    protected void write(final DataOutput out) throws IOException {
        ...
        // Field Name
        out.write(this.fieldName); /* 0-10 */
        out.write(new byte[11 - this.fieldName.length]);
        
        // data type
        out.writeByte(this.dataType); /* 11 */
    ...
    public String getName() {
        ...
        String fileName = "";
        try {
            // System.out.println("getName方法所获得的字段名称："+ new String(this.fieldName, 0,
            // this.nameNullIndex, "GBK"));
            fileName = new String(this.fieldName, 0, this.nameNullIndex, "GB2312");
     ...
     * 
     * If the field is specified to hold integral values the value returned by this method will be
     * zero.
     * 
    ...
    /**
     * @deprecated This method is depricated as of version 0.3.3.1 and is replaced by
     *             {@link #setName(String)}.
     */
    @Deprecated
    ...
    public void setName(final String value) {
        ...
        try {
            this.fieldName = value.getBytes("GBK");
        } catch (final UnsupportedEncodingException e) {
            e.printStackTrace();
        }
