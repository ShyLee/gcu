...
public final class SpaceTransactionAssignmentHelper {
    ...
    public static AssignmentObject convertJSONObjectToRmpctObject(final JSONObject jsonObject) {
        ...
        roomTransaction
            .setActivityLogId(jsonObject.optInt(SpaceConstants.ACTIVITY_LOG_ID, 0) == 0 ? null
                    : jsonObject.optInt(SpaceConstants.ACTIVITY_LOG_ID, 0));
        
        roomTransaction.setMoId(jsonObject.optInt(SpaceConstants.MO_ID, 0) == 0 ? null : jsonObject
            .optInt(SpaceConstants.MO_ID, 0));
        roomTransaction.setPercentageOfSpace(jsonObject.optDouble(SpaceConstants.PCT_SPACE, 0));
        
        final Date dateStart = (Date) jsonObject.opt(SpaceConstants.DATE_START);
        final Date dateEnd = (Date) jsonObject.opt(SpaceConstants.DATE_START);
