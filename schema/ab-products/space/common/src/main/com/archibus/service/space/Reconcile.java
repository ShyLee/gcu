...
public final class Reconcile {
     ...
     */
    public static void reconcileRoomTransactions() {
    ...
    private static void synchronizeEmLocationInRmpct() {
        ...
        for (final DataRecord emRecord : emRecords) {
            // TODO: (VT): do not use "new", use dependency injection instead -KB3038266
            final Employee employee = new EmployeeDataSource().convertRecordToObject(emRecord);
