/*
 * $Id: DBFBase.java,v 1.3 2004/03/31 15:59:40 anil Exp $ Serves as the base class of DBFReader adn
 * DBFWriter.
 * 
 * @author: anil@linuxense.com
 * 
 * Support for choosing implemented character Sets as suggested by Nick Voznesensky
 * <darkers@mail.ru>
 */
/**
...
public abstract class DBFBase {
    ...
    protected String characterSetName = "GBK";
    ...
    /*
     * If the library is used in a non-latin environment use this method to set corresponding
