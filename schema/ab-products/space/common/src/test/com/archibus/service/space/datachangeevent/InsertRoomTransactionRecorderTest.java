...
public class InsertRoomTransactionRecorderTest extends TestCase {
    ...
    public void testRecordInsertTransaction() {
        ...
        final IRoomTransactionDao roomTransactionDao = new IRoomTransactionDao() {
            ...
            public List<RoomTransaction> findPrimaryForEmployee(final Employee employee,
                    final Date dateTime) {
                // Auto-generated method stub
                return null;
            }
            ...
            public List<RoomTransaction> findEmLocationChange(final Employee employee,
                    final Date dateTime) {
                // TODO Auto-generated method stub
                return null;
            }
            
            public List<RoomTransaction> findEmDepartmentChange(final Employee employee,
                    final Date dateTime) {
                // TODO Auto-generated method stub
                return null;
            }
            
            public List<RoomTransaction> findRoomAttributeChange(final Room room,
                    final Date dateTime) {
                // TODO Auto-generated method stub
                return null;
            }
