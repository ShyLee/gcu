...
public class ChangeDataType extends CreateAlterTable {
    ...
    private void runChangeDataTypeWorkflow(final CompareFieldDef fieldToCompare) {
        ...
        final String newFieldName = fieldToCompare.getArcFieldDef().getName();
        final String tableName = fieldToCompare.getSysFieldDef().getTableName();
        final String oldFieldName = fieldToCompare.getSysFieldDef().getName();
