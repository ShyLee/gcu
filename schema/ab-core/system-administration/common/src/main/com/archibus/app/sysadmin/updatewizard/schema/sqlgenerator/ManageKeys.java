...
public class ManageKeys {
     ...
     */
    public ManageKeys() {
        // initialize object later using setters.
    }
     ...
     */
    public void reCreatePrimaryKeys(final boolean isCreateSequence) {
        this.managePk.dropAllPrimaryKey();
        final String stmts = this.managePk.createAllPrimaryKeys(isCreateSequence);
