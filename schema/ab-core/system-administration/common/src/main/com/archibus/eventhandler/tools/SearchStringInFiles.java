...
import com.archibus.servletx.utility.FileHelper;
 ...
 * @author Emily Dich
 */
public class SearchStringInFiles extends SearchService {
    /**
     * .axvw extension.
     */
    ...
    public void addFileAndContinueSearch(final String name) {
        ...
        // try {
        final String dependentFullPath = FileHelper.findFile(context, fileName);
    ...
    public void searchForDependentFiles(final String filePath, final String fileName) {
        ...
        if (doc != null) {
            ...
            while (elementIterator.hasNext()) {
                ...
                if (file != null && !fileName.equals(file)
                        && !file.endsWith(SearchStringInFiles.HTM_EXT)) {
                    addFileAndContinueSearch(file);
                }
                if (viewName != null && !fileName.equals(viewName)
