...
public class SectionProperty extends Property {
    ...
    /**
     * Comments all entries.
     * 
     * @throws IOException exception
     */
    private void commentAllEntries() throws IOException {
        ...
        while (currentLine != null) {
            ...
            commentSection(bReader, contents, false);
    ...
    public void commentAppDeploy(final List<String> commentTextList, final boolean unComment)
            throws IOException {
        if (commentTextList.size() == 1 && "all".equals(commentTextList.get(0).toLowerCase())) {
            commentAllEntries();
            return;
        }
        final StringBuilder contents = new StringBuilder();
