...
public class FolderTree {
    ...
    private JSONArray getChildren(final String folder) {
        final File localFile = new File(folder);
        final File[] fList = localFile.listFiles();
        ...
        for (final File pathElement : fList) {
            ...
            if (pathElement.isFile()) {
                ...
                if (FolderTree.TYPE_LIST[1].equals(ext.toLowerCase())) {
                    ...
                    // children.put(element.getName());
                    child.put(ELEMENT_NAME, elem.getElementName());
                    child.put(ELEMENT_TYPE, elem.getType());
                    // child.put("elementParentPath", elem.getParentPath());
                    // child.put("elementParentName", elem.getParentName());
    ...
    public String getFolderList() {
        ...
        try {
            ...
            Logger.getLogger(this.getClass()).error(
                MessageFormat.format("Package and Deploy Wizard: [{0}]",
