    ...
    public void testOnApplicationEvent() {
        {
            ...
            final WorkflowRuleInvokerDataEventListener workflowRuleInvokerDataEventListener = new WorkflowRuleInvokerDataEventListener();
            final CallbackFlag callbackFlag = new CallbackFlag();
            final ApplicationContext applicationContext = MockUtilities
                .createMockApplicationContext(callbackFlag);
            ...
            final SqlExecutedEvent sqlExecutedEvent = new SqlExecutedEvent(this, null, null, null,
                null);
        ...
        
        {
            ...
            // event parameters don't matter here
            final ApplicationEvent event = new HttpSessionCreatedEvent(
