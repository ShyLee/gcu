...
var abSchemaAddFieldCtrl = View.createController('abSchemaAddFieldCtrl', {
	...
	abSchemaAddField_form_afterRefresh: function(){
		checkFormFields();
		// disable input for table name and enable select value action
		this.abSchemaAddField_form.enableField("afm_flds.table_name", false);
		this.abSchemaAddField_form.fields.get("afm_flds.table_name").actions.get("selectTable").enable(true);
	},
