...
Ab.flash.Gantt = Ab.flash.FlashControl.extend({
	...
	z_MESSAGE_SETPREDECESSOR_TOOLTIP: 'To set a Predecessor Task, hold down the <Ctrl> key while selecting two task items in the Gantt Chart.  The item selected first will become the predecessor of the second.  Then select Set as Predecessor.',
	z_MESSAGE_START: 'Start',
	z_MESSAGE_END: 'End',
