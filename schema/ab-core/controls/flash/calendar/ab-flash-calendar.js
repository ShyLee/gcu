...
Ab.flash.Calendar = Ab.flash.FlashControl.extend({
	...
	getLocalizedString_calendar: function(input) {
 	...
 	// constructor
    constructor: function(controlId, dataSourceId, primaryKeyField, summaryField, startTimeField, endTimeField, showWeekend, additionalSWFParam) {
    	calendarControl = this;
    	var swfParam = '?panelId=' + controlId;
    	if (typeof(additionalSWFParam)!="undefined") {
