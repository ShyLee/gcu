...
<!--                             <div style="display:block; padding-bottom: 10px;" id="password_email_request" display="none"> -->
...
<!--                         <a id="guest_button">Sign in as &ldquo;guest&rdquo;</a> -->
                        ...
                        <div class="callout" id="changeLocaleCallout">
                            <div style="display:block; padding-bottom: 10px;" id="language_label" display="none">Select your language:</div>
