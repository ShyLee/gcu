...
//	}
    afterViewLoad: function(){
    	...
    	if(roleName=="UNV EQ ADMIN"){
    	   this.users.addParameter("roleNames","afm_users.role_name in ('UNV DV EQ ADMIN','UNV DV EQ OWN ADMIN','UNV EQ HEAD','UNV EQ ADMIN')");
    	}else if(roleName=="UNV STU ADMIN"){
    		this.users.addParameter("roleNames","afm_users.role_name in ('UNV DV STU ADMIN','UNV STU ADMIN')");
    	}
    },
